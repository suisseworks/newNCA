			...
			<div class="col-lg-4 main_text">
				...
				<div class="detail_main_col d-flex align-items-end h-100">
				    <div class="detail_searcher sbs_deatail mt-5 position-relative">
	                    ...
	                    <h2 class="font__halvetica-bold text-uppercase font__size-133 line__height-160 position-relative"><span class="heading_bg">NICK</span> <br> <sapn class="heading_bg_2">AKERS</sapn></h2>
				    </div>	
				</div>    
			</div>
			<div class="col-lg-8">
				<div class="searcher_image position-relative">
					<img class="w-100" src="img/Nick-Akers.png">
				</div>	
			</div>	
		</div>
	...
	<div class="outer_container container-outer-1600 pb-lg-200 pb-50">
				...
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/grey-factory.jpg">
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/pills.jpg">
							<div class="transform_div position-absolute">
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/workers.jpg">
							<div class="transform_div position-absolute">
			...
			<div class="col-lg-4 pr-lg-20">
				<div class="video_text about_contact_info pl-45 pr-30 pb-30 w-100 d-flex h-100 align-items-center">
					<div>
                        ...
                        The strength of the team is each member. <br> The strength of each member is the team.<br><br>							 
						</h2>
						...
						<p class="font__size-20 line__height-24 font__family-open-sans font-weight-bold text-golden pl-30">
							Phil Jackson<br> Coach and former professional basketball player
						</p> 
					</div>	
				</div>	
			</div>
		...
		<div class="row pt-50 pb-130">
			<div class="col-lg-4 pr-lg-20">
				<div class="learn_more_btns sbs_download_btn resume_btn pt-30 pb-30 pl-70 pr-70 d-flex justify-content-center">
					<a download href="docs/Nick-Akers-resume.pdf" type="button" class="pb-1 btn text-primary font-weight-bold text-left font__family-open-sans text-uppercase font__size-45 line__height-60 p-0 m-0">DOWNLOAD<br> RESUME
				...
				<div class="info_text sabastien_col mt-lg-0 mt-50 p-xs-0 pl-50 pr-50 pt-100 pb-100">
                    ...
                    <ul class="pl-0 mt-30">
                    	<li class="w-100 mb-30">
                    		<a class="font__halvetica-bold pr-50 text-white font__size-38" href="mailTo:nick.akers@novastone-ca.com">nick.akers@novastone-ca.com</a>
                    	</li>
                    </ul>
				</div>	
			</div>	
				...
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-27 font__family-avenir text-capitalize line__height-70 text-white">Nick Akers</h1>
