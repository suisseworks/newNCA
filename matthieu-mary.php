		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-5032 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Strategic thinking & execution </li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Business developer</li>
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Sustainable value creator</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">My focus is to acquire a company operating a complex supply chain directly or indirectly, such as Transport & Logistics operators, Specialized wholesalers, Industrial products manufacturers, Industrial services providers; in the South West of France.  </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">My goal is to elevate the company I acquire to new heights by expanding its business and enhancing its efficiency. I plan to achieve this by building on the existing team’s strengths and successes, while adding my own experience in sales, business development, operations, and innovation </p>
			...
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Talent wins games, but teamwork and intelligence win championships.</h4>
