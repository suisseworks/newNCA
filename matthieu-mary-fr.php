				...
				<div class="searcher_content pt-100 ml-4">
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
                            ...
                            <a href="http://novastone-ca.com/matthieu-mary.php" class="bg-transparent mt-110 ml-10 font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">English</a>
						</div>
					</div>		
					<div class="detail_searcher mt-2">
						...
						<p class="font__size-18 line__height-24">J'ai grandi à Toulouse, et mes racines s'étendent de l'océan Atlantique aux Pyrénées, où j'ai choisi de m'installer en 2022 après un parcours international. Diplômé ingénieur de l'École des Mines de Paris, j'ai débuté par trois années en conseil en stratégie avant d'occuper divers postes de direction chez deux leaders mondiaux de la logistique. Désireux de m'éloigner des grands groupes, j'ai pris goût à l'entrepreneuriat au sein d'une startup spécialisée dans le transport d'objets d'art. <br><br>Passionné par les transitions, notamment environnementale et numérique, je souhaite aujourd'hui reprendre et développer une PME industrielle dans le sud-ouest de la France. </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:matthieu.mary@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-5032 pb-80 pt-50 ml-40">
					<h2  class="text-uppercase font__family-efb line__height-70 text-brand-primary">Compétences clés<span style="color: transparent"><span></h2>
					<ul class="ml-5 pl-4">
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Leadership par le service</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>De la stratégie à son exécution </li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Développement commercial</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Orienté résultats </li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Créateur de valeur durable</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">Mon objectif est d'acquérir une entreprise gérant une chaîne d'approvisionnement complexe, directement ou indirectement, telle qu'un opérateur de transport et logistique, un grossiste spécialisé, un fabricant de produits industriels, ou un fournisseur de services industriels, dans le sud-ouest de la France. </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">Mon objectif est de mener l'entreprise que je reprendrai vers de nouveaux sommets, en développant son activité et en améliorant son efficacité. Je m'appuierai pour cela sur le savoir-faire de l'équipe en place, tout en apportant mon expérience en développement commercial, en optimisation des opérations et en innovation.                     </p>
					<p class="font__size-16 line__height-24 mt-1"> </p>    
			</div>
		</div>
	</div>
	</div>
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                    ...
                    <div class="play_button left_btn center_btn play_btn_white position-absolute">
	                    <a class="d-flex align-items-center fancybox" href="https://www.youtube.com/watch?v=UcWhggVxHWQ&t=1s" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                    </div>
                </div>
			</div>
			<div class="col-lg-1"></div>
			...
			<div class="col-lg-4 bg-white">
				<div class="about_learn pt-100 pb-80 pl-100 pr-100">
					...
					<div class="learn_more_btns learn_about_btn mt-5 mb-4 pb-2">
						<a href="about-us.php" target="__blank" type="button" class="btn text-white text-uppercase font__size-24 p-0 d-flex align-items-center m-0">Apprendre encore plus<span class="ml-5 d-flex"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="38" height="38" viewBox="0 0 38 38">
							  <defs>
							    <clipPath id="clip-path">
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:matthieu.mary@novastone-ca.com">matthieu.mary@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Le talent fait gagner des matchs, mais le travail d'équipe et l'intelligence font gagner des championnats</h4>
							<h5 class="font__size-23 line__height-35 font__family-open-sans font-weight-bold mt-3 text-uppercase">Michael Jordan</h5>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">Matthieu Mary</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:matthieu.mary@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">matthieu.mary@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/matthieumary/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
