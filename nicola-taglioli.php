				...
				<div class="searcher_content pt-100 ml-4">
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							<a href="https://www.linkedin.com/in/nitagli/" target="_blank" class="social_icon searcher_linkdin mt-100 d-inline-flex align-items-center ml-2 justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
							 
						</div>
					</div>		
					<div class="detail_searcher mt-2">
						<h2 class="font__family-efb text-uppercase line__height-90">Nicola <br> Taglioli</h2>
						...
						<p class="font__size-18 line__height-24"> Born and raised in Tuscany (Galileo Galilei's hometown), I've always been driven by a thirst for knowledge and a passion for innovation.  
<br> <br>
My 25 years of professional experience, honed across major organizations and Italian SMEs in four European countries, have fuelled my entrepreneurial spirit and instilled in me the importance of continuous learning and global perspective. As a father of three, I'm deeply invested in building a better and sustainable future.     </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:nicola.taglioli@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-5032 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Entrepreneur & Leader </li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Visionary & Strategist </li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Business Transformation </li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Continuous Learner   </li>
			...
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">My search focuses on acquiring a successful and innovative Italian SME operating within the Industrial B2B space, specifically within the Packaging, Industrial Automation, Robotics, or Power Electronics sectors. This company should be a leader in its niche segment, demonstrating agility and leveraging technological advancements within its product portfolio to generate recurring revenues. </p>
					<p class="font__size-16 line__height-24 mt-2">The ideal target company will possess a strong asset base with minimal capital expenditure requirements, have a proven track record of success spanning at least 30 years, and exhibit a revenue range between €10M and €50M with a robust EBITDA margin exceeding 15%.  </p>
                    <p class="font__size-16 line__height-24 mt-2">Furthermore, the company should offer significant upside potential through avenues such as geographical expansion, broadening its product range, expanding service offerings, and enhancing operational efficiency. This search is specifically targeted towards companies located in Northern Italy. </p>
...
I am driven by a commitment to extending the company's legacy and creating a thriving ecosystem for clients, employees, and suppliers. Leveraging my experience in leading teams, managing complex projects, and driving operational excellence, I will contribute to continued success and unlock new growth opportunities.  </p>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                    <img src="img/thumbnail-nicola.png" alt="alt" class="image_video">
                    <div class="play_button left_btn center_btn play_btn_white position-absolute">
	                    <a class="d-flex align-items-center fancybox" href="https://youtu.be/5cbBoYvE2Ek" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                    </div>
                </div>
			</div>
			<div class="col-lg-1"></div>
...
<section class="resume_sec searcher_bg">
	<div class="pt-150 pb-100">
		<div class="row no-gutters">
			...
			<div class="col-lg-8">
				<img src="img/nicola-background.png" class="resume_img">
			</div>
		</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:nicola.taglioli@novastone-ca.com">nicola.taglioli@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">If you always do what you've always done, you'll always get what you always got</h4>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">NICOLA TAGLIOLI</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:nicola.taglioli@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">nicola.taglioli@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/nitagli/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
