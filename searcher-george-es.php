				...
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							...
							<a href="http://novastone-ca.com/searcher-george.php" class="bg-transparent mt-110 ml-10 font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">English</a>
						</div>
					</div>	
					...
					<div class="detail_searcher mt-2">
						<h2 class="font__family-efb text-uppercase line__height-90">George <br> Berczely </h2>
						...
						<p class="font__size-18 line__height-24">De nacionalidad británica y austríaca, he vivido y trabajado en 10 países antes de radicarme en España, por su gente y por la excelente calidad de vida que ofrece. Más de 20 años de experiencia en logística y en transformaciones empresariales me han dotado con una pasión por armar y liderar grandes equipos. Me energiza trabajar junto a ellos, hombro a hombro, sabiendo que siempre hay más que podemos hacer para satisfacer a nuestros clients y hacer crecer el negocio.  </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:george.berczely@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contacto<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-50 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Liderazgo de Servicio</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Visión estratégica</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Resiliencia</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Obtención de resultados</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Humildad</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">Busco adquirir una empresa española que brinde servicios a empresas, con ingresos anuales de €10-50 millones. La empresa ideal debería tener una trayectoria de muchos años y una fuerte reputación, una cartera de clientes estable y un sólido equipo de profesionales que me propongo mantener. </p>
					<p class="font__size-16 line__height-24 mt-2">Estoy particularmente interesado en empresas relacionadas con la logística y servicios afines.  </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">He pasado la mayoría de mi vida profesional transformando empresas para que alcancen su máximo potencial. Quiero poner esta experiencia a disposición de la empresa que voy a adquirir. Definiremos objetivos ambiciosos, detallaremos un plan de acciones parar alcanzarlos, y capacitaremos a la organización para ejecutarlo con disciplina. </p>
					<p class="font__size-16 line__height-24 mt-1"> Todo esto comienza con un gran equipo, al cual consolidaremos y reforzaremos. Adicionalmente, con mi experiencia podré agregar valor en la digitalización e internacionalización.  </p>    
			</div>
		</div>
	</div>
	</div>
...
<section class="resume_sec searcher_bg">
	<div class="pt-150 pb-100">
		<div class="row no-gutters">
			...
			<div class="col-lg-8">
				<img src="img/background-george.png" class="resume_img">
			</div>
		</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:george.berczely@novastone-ca.com">george.berczely@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Tanto si crees que puedes como si no, tienes razón</h4>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">George Berczely</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:george.berczely@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">george.berczely@novastone-ca.com</a>
