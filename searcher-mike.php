				...
				<div class="searcher_content pt-100 ml-4">
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							...
							<a href="http://novastone-ca.com/searcher-mike-en.php" class="bg-transparent mt-110 ml-10 font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">English</a>
						</div>
					</div>		
					<div class="detail_searcher mt-2">
						<h2 class="font__family-efb text-uppercase line__height-90">Mike <br> Hindi</h2>
...
Insgesamt bin ich eine global denkende Führungskraft, die 6 Sprachen spricht und in 9 Ländern auf 4 Kontinenten gelebt hat.
					...
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:mike.hindi@novastone-ca.com" type="button" class="btn text-white font__family-efb">Kontakt<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
			...
			<div class="row">
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:mike.hindi@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">mike.hindi@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/mike-hindi" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
