...
.posts-section-one.post-item,.posts-section-two.post-item{
	padding-left: 15px;
    padding-right: 15px;
}
}
				...
				<div class="col-md-4 mt-4">
					<div class="card ">
						...
						<div class="card-body" style="width: 23rem !important">
							<h5 class="card-title" style="font-size: 20px; font-weight: 800;"><?php echo $blog['title'] ?></h5>
			...
			fetch(nextPageUrl)
				...
				.then(data => {
					...
					if (data.data.data.length > 0) {
						...
						<div class="card-body" style="width: 23rem !important">
							<h5 class="card-title" style="font-size: 20px; font-weight: 800;">${blog.title}</h5>
