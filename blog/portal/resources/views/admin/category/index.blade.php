                        ...
                        <tbody id="ihub-news-records">
                            ...
                            <tr class="gradeX" style="cursor: pointer;">
                                ...
                                <td class="">
                                    ...
                                    <button class="delete-button btn btn-light btn-sm btn-block" data-id="{{$category->id}}" data-toggle="tooltip" data-placement="top" onclick="deletePrompt({{$category->id}})" title="Delete">
...
<div class="modal fade" id="editRecord" tabindex="-1" aria-labelledby="editRecord" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" form="editRecordForm" onclick="disableEditBtn(this)" class="btn btn-primary">Save changes</button>
            </div>
        </div>
    </div>
</div>
