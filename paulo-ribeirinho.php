				...
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							...
							<a href="paulo-ribeirinho-pt.php" class="bg-transparent mt-110 ml-10 font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">Português</a>
						</div>
					</div>	
					...
					<div class="detail_searcher mt-2">
                        ...
                        I was born and raised in Portugal, but I have lived and worked in Nigeria, Singapore, France, United Kingdom, and Brazil. I am an engineer by training, and my career has taken me from the manufacturing industry to executive positions in e-commerce startups in several geographies and big tech. I have found entrepreneurship to be my passion and it is my objective to achieve it through acquisition.  </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:paulo.ribeirinho@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-50 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Industrial Operations</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Digitalization</li>
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Business Scaling</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
                    ...
                    My focus is on acquiring a profitable manufacturing or service SME generating €10-50 million in revenue and located in Portugal or, opportunistically, in the services sector in Portugal or Spain. </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">My objective is to combine my industrial operations expertise with my digital business scaling experience and provide a value creation plan for the acquired company while preserving the founder’s legacy.   </p>
					<p class="font__size-16 line__height-24 mt-1">My diverse background in scaling operations, developing technology businesses, and building large teams in multiple geographies leads me to believe I can take the company into a new growth cycle which will create value for employees and shareholders.  </p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                        ...
                        <a class="d-flex align-items-center fancybox" href="https://youtu.be/RNm1ypLlcH0" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                        </div>
                     </div>
			</div>
			<div class="col-lg-1"></div>
			...
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Our greatest glory is not in never falling, but in rising every time we fall.</h4>
