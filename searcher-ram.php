			...
			<div class="col-lg-4 main_text">
				...
				<div class="detail_main_col d-flex align-items-end h-100">
				    <div class="detail_searcher sbs_deatail mt-5 position-relative">
	                    ...
	                    <h2 class="font__halvetica-bold text-uppercase font__size-133 line__height-160 position-relative"><span class="heading_bg">RAM</span> <br> <sapn class="heading_bg_2">SRIRAM</sapn></h2>
				    </div>	
				</div>    
			</div>
			<div class="col-lg-8">
				<div class="searcher_image position-relative">
					<img class="w-100" src="img/ram.png">
				</div>	
			</div>	
		</div>
	...
	<div class="outer_container container-outer-1600 pb-lg-200 pb-50">
				...
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/about-us-ram.png">
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/search-ram.png">
							<div class="transform_div position-absolute">
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/contribution-ram.png">
							<div class="transform_div position-absolute">
				...
				<div class="video_text about_contact_info pl-45 pr-30 pb-30 w-100 d-flex h-100 align-items-center">
					<div>
						...
						<p class="font__size-20 line__height-24 font__family-open-sans font-weight-bold text-golden pl-30">
							Thomas Edison<br> a great American inventor & businessman. 
						</p> 
					</div>	
				</div>	
			</div>
			<div class="col-lg-8 pl-lg-20">
				<div class="video_div d-flex h-100 pt-lg-0 pt-50">
					<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
	                    <img src="img/play-sec-ram.png" alt="alt" class="image_video object-fit_cover w-100 h-100">
	                    <div class="sbs_btn play_button left_btn center_btn play_btn_white position-absolute">
		                    <a class="d-flex align-items-center fancybox" href="https://youtu.be/q3OX7jhufdw" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-18 font__family-open-sans">PLAY</span></a>
	                    </div>
	                </div>
				</div>	
			</div>	
		...
		<div class="row pt-50 pb-130">
			<div class="col-lg-4 pr-lg-20">
				<div class="learn_more_btns sbs_download_btn resume_btn pt-30 pb-30 pl-70 pr-70 d-flex justify-content-center">
					<a download href="docs/Ram-Sriram-resume.pdf" type="button" class="pb-1 btn text-primary font-weight-bold text-left font__family-open-sans text-uppercase font__size-45 line__height-60 p-0 m-0">DOWNLOAD<br> RESUME
				...
				<div class="info_text sabastien_col mt-lg-0 mt-50 p-xs-0 pl-50 pr-50 pt-100 pb-100">
                    ...
                    <ul class="pl-0 mt-30">
                    	<li class="w-100 mb-30">
                    		<a class="font__halvetica-bold pr-50 text-white font__size-38" href="mailTo:ram.sriram@novastone-ca.com">ram.sriram@novastone-ca.com</a>
                    	</li>
                    </ul>
				</div>	
			</div>	
				...
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-27 font__family-avenir text-capitalize line__height-70 text-white">Ram Sriram</h1>
