				...
				<div class="searcher_content pt-100 ml-4">
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							<a href=" https://www.linkedin.com/in/marc-decoste-09a29211/" target="_blank" class="social_icon searcher_linkdin mt-100 d-inline-flex align-items-center ml-2 justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
						 
						</div>
					</div>		
					<div class="detail_searcher mt-2">
						<h2 class="font__family-efb text-uppercase line__height-90">Marc <br> Decoste</h2>
						...
						<p class="font__size-18 line__height-24"> I grew up in Canada and have lived in Guam, the Philippines, the UK, and several US cities. I’ve worked for small and large companies, in corporate and startup settings, and across roles ranging from business development to strategic finance. Entrepreneurship has been a consistent theme throughout my career and is now the focus of my work with NCA.  </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:marc.decoste@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-5032 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Organizational leadership </li>
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Process design </li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">I aim to find and grow a business faced with succession challenges, where I can offer continuity, stability, and path to ongoing success for years to come.    </p>
					<p class="font__size-16 line__height-24 mt-2">I am particularly interested in mission-oriented businesses, such as those addressing sustainability problems. Operations can be located anywhere in the United States. </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">You’ll find me to be an energetic problem-solver, a collaborator, and someone genuinely eager to learn the ins and outs of the business.   </p>
					<p class="font__size-16 line__height-24 mt-1">I’ll bring with me expertise spanning, amongst other things, clean tech, renewables, and infrastructure, and over 10 years of leadership experience in finance, strategy, business development, and analytics. 
 </p>    
			</div>
		</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                    <img src="img/marc-thumbnail.png" alt="alt" class="image_video">
...
<section class="resume_sec searcher_bg">
	<div class="pt-150 pb-100">
		<div class="row no-gutters">
			...
			<div class="col-lg-8">
				<img src="img/marc-decoste-background.png" class="resume_img">
			</div>
		</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:marc.decoste@novastone-ca.com">marc.decoste@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Discipline equals freedom</h4>
							<h5 class="font__size-23 line__height-35 font__family-open-sans font-weight-bold mt-3 text-uppercase">Jocko Willink</h5>
							<p class="font__size-16 line__height-35 mt-2 text-uppercase">U.S. Navy Seal</p>
					</div>
				</div>
			  </div>
		</div>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">MARC DECOSTE</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:marc.decoste@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">marc.decoste@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/marc-decoste-09a29211/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
