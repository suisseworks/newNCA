				...
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							<a href="https://www.linkedin.com/in/mbhat/" target="_blank" class="social_icon searcher_linkdin mt-100 d-inline-flex align-items-center ml-2 justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					...
					<div class="detail_searcher mt-2">
						<h2 class="font__family-efb text-uppercase line__height-90">Manjunath   <br> Bhat</h2>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-50 pb-80 pt-50 ml-40">
					<h2 class="manjunath text-uppercase font__family-efb line__height-70 text-brand-primary">
						Key Skills
					</h2>

					<ul class="ml-5 pl-4">
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Customer focused</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>People centric</li>
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Life-long learner</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Servant leader</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">Today's companies are facing an immense digital challenge in post COVID world, and many small businesses are figuring out their response.</p>
					<p class="font__size-16 line__height-24 mt-2">My search focuses on vertically driven technology and engineering services company, particularly addressing industrial automation or digital transformation needs. My goal is to take your legacy and company forward in this new era. </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">Over the years, I have gained a breadth of experience in building strategic vision, planning and executing those plans.  </p>
					<p class="font__size-16 line__height-24 mt-1">I understand the challenge of starting a new business, growing it and what it takes to keep customers & employees happy. I would like to bring my entrepreneurial spirit, experience in product and technology development to help take the company forward.  </p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                        <img src="img/play-sec-manjunath.png" alt="alt" class="image_video">
                        <div class="play_button left_btn center_btn play_btn_white position-absolute">
                        <a class="d-flex align-items-center fancybox" href="https://youtu.be/nyBOmB2ym6o" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                        </div>
                     </div>
			</div>
			<div class="col-lg-1"></div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4 bg-white">
				...
				<div class="learn_more_btns resume_btn bg-primary pt-60 pb-60 pl-100 pr-100">
						<a download2 href="https://www.linkedin.com/in/mbhat/ " type="button" class="pb-1 btn text-white d-inline-flex align-items-center text-uppercase font__size-20 p-0 m-0">Visit my LinkedIn Profile<span class="ml-5 d-flex"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="38" height="38" viewBox="0 0 38 38">
								  <defs>
								    <clipPath id="clip-path">
								      <rect width="38" height="38" fill="none"/>
								    </clipPath>
								  </defs>
								  <g id="Forward_arrow" data-name="Forward arrow" transform2="translate(38) rotate(90)" clip-path="">
								    <path id="Path_10" data-name="Path 10" d="M19,0,15.545,3.455,28.623,16.532H0v4.935H28.623L15.545,34.545,19,38,38,19Z" fill="#fff"/>
								  </g>
								</svg>
								</span></a>
			...
			<div class="col-lg-8">
				<img src="img/background-manjunath.png" class="resume_img">
			</div>
		</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:manjunath.bhat@novastone-ca.com">manjunath.bhat@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Everything is created twice, first in the mind and then in reality.</h4>
							<h5 class="font__size-23 line__height-35 font__family-open-sans font-weight-bold mt-3 text-uppercase">Robin Sharma</h5>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">Manjunath Bhat</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:manjunath.bhat@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">manjunath.bhat@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/mbhat/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
