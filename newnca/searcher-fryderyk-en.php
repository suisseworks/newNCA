				    ...
				    <div class="detail_searcher sbs_deatail mt-5 position-relative">
						<div class="member_content py-4">
                        	<div>
								...
								<a style="margin-top: -2px" href="http://novastone-ca.com/searcher-fryderyk.php" class="bg-transparent   ml-10 font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">Polish</a>
						    </div>	
	                    </div>
			...
			<div class="col-lg-4 pr-lg-20">
				<div class="video_text about_contact_info pl-45 pr-30 pb-30 w-100 d-flex h-100 align-items-center">
					<div>
						...
						It is not enough <br> to do your best; <br> you must know what to do, <br> and then do your best.
						...
						W. Edwards Deming<br> American engineer, statistician, professor and author
						</p> 
					</div>	
				</div>	
			</div>
		...
		<div class="row pt-50 pb-130">
			<div class="col-lg-4 pr-lg-20">
				<div class="learn_more_btns sbs_download_btn resume_btn pt-30 pb-30 pl-70 pr-70 d-flex justify-content-center">
					<a download href="docs/Fryderyk-Rdultowski-resume.pdf" type="button" class="pb-1 btn text-primary font-weight-bold text-left font__family-open-sans text-uppercase font__size-45 line__height-60 p-0 m-0">DOWNLOAD<br> RESUME
