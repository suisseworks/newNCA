			...
			<div class="col-lg-4 main_text">
				...
				<div class="detail_main_col d-flex align-items-end h-100">
				    <div class="detail_searcher sbs_deatail mt-5 position-relative">
						<h2 class="font__halvetica-bold text-uppercase font__size-133 line__height-160"><span class="heading_bg">FRYDERYK</span> <br> <sapn class="heading_bg_2">Rdułtowski</sapn></h2>
