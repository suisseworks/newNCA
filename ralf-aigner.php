				...
				<div class="detail_main_col d-flex align-items-end h-100">
				    <div class="detail_searcher sbs_deatail mt-5 position-relative">
	                    ...
	                    <h2 class="font__halvetica-bold text-uppercase font__size-133 line__height-160">
							<p class="heading_bg">Ralf</p>
							<p class="heading_bg_2">Aigner</p>
						</h2>
				    </div>	
				</div>    
			</div>
					...
					<div class="col-lg-5 pl-lg-20">
						<div class="image_text_div py-lg-0 py-4 h-100 font__halvetica-regular">
							<p class="mt-30 font__size-16">
                              I'm Ralf Aigner, a 43-year-old entrepreneur based in Munich. As a father of two and a passionate skier, I bring the same enthusiasm and dedication to my professional endeavors. Over the years, I have co-founded a management consultancy, started a successful company in Mexico, and scaled B2B businesses across Europe. Now, I am on a mission to acquire a B2B service business in Germany and lead it to new heights.
							</p>
		...
		<div class="row pt-50 pb-130">
			<div class="col-lg-4 pr-lg-20">
				<div class="learn_more_btns sbs_download_btn resume_btn pt-30 pb-30 pl-70 pr-70 d-flex justify-content-center">
					<a download href="docs/ralf-aigner-resume.pdf" type="button" class="pb-1 btn text-primary font-weight-bold text-left font__family-open-sans text-uppercase font__size-45 line__height-60 p-0 m-0">DOWNLOAD<br> RESUME
