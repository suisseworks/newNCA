				    ...
				    <div class="detail_searcher sbs_deatail mt-5 position-relative">
						<div class="member_content py-4">
                        	<div>
			        			...
			        			<p class="font__size-30 font__halvetica-bold line__height-50"><span class="pb-15 d-inline-block">NCA Entrepreneur</span><br><span class="font__size-41">2022</span> <span class=" member_count_arrow px-lg-3 pt-lg-12 pt-10 d-inline-flex">
								...
								<p style="margin-top: 8px;  "> <a href="https://www.linkedin.com/in/david-t-lin" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5  mr-2"><i style="font-size: 20px;" class="fab fa-linkedin-in"></i></a>
								
						    </div>	
	                    </div>
	                    <h2 class="font__halvetica-bold text-uppercase font__size-133 line__height-160 position-relative"><span class="heading_bg">DAVID</span> <br> <sapn class="heading_bg_2">LIN</sapn></h2>
				    </div>	
				</div>    
			</div>
			<div class="col-lg-8">
				<div class="searcher_image position-relative">
					<img class="w-100" src="img/david-lin.png">
				</div>	
			</div>	
		</div>
				...
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/about-me-david-lin.jpg">
...
I am a serial entrepreneur with 20 years of experience.
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/contribution-david-lin.jpg">
							<div class="transform_div position-absolute">
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/search-david-lin.jpg">
							<div class="transform_div position-absolute">
		...
		<div class="row pt-50 pb-130">
			<div class="col-lg-4 pr-lg-20">
				<div class="learn_more_btns sbs_download_btn resume_btn pt-30 pb-30 pl-70 pr-70 d-flex justify-content-center">
					<a download href="docs/David-Lin-resume.pdf" type="button" class="pb-1 btn text-primary font-weight-bold text-left font__family-open-sans text-uppercase font__size-45 line__height-60 p-0 m-0">DOWNLOAD<br> RESUME
				...
				<div class="info_text sabastien_col mt-lg-0 mt-50 p-xs-0 pl-50 pr-50 pt-100 pb-100">
                    ...
                    <ul class="pl-0 mt-30">
                    	<li class="w-100 mb-30">
                    		<a class="font__halvetica-bold pr-50 text-white font__size-38" href="mailTo:david.lin@novastone-ca.com">david.lin@novastone-ca.com</a>
                    	</li>
                    </ul>
				</div>	
			</div>	
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-27 font__family-avenir text-capitalize line__height-70 text-white">David Lin</h1>
				...
				<div class="col-12 col-lg-5 text-lg-right">
					<div class="searcher_mail d-flex align-items-center justify-content-end mt-3 pt-1">
						<a href="mailTo:david.lin@novastone-ca.com" class="font__size-17 text-brand-primary font__halvetica-bold font-weight-bold underline mr-3"><span>david.lin@novastone-ca.com</span></a>
						<a href="https://www.linkedin.com/in/david-t-lin" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
