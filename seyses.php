		...
		<div class="row no-gutters">
				...
				<div class="forza-top-content pl-50">
					...
					<div class="col-12 visit-btn px-0 mt-5">
						<div class="d-flex align-items-center justify-content-center talent_btn_learn h-100 pb-lg-0 pb-sm-2 pl-lg-50">
								<a href="https://seyses.com/es/en/" target="_blank" class="social_icon d-inline-flex align-items-center h-100 justify-content-start border-radius-0 p-2 pl-50 text-white bg-primary w-100 text-uppercase">Visit Website</a>
							</div>
					</div>
				</div>	
			</div>
            ...
            <div class="col-lg-6 bg-white">
                ...
                <div class="forza-list mt-5 text-left">
							<ul>
								<li>
									<strong>Headquarters:</strong> Seville, Spain
								</li>
								<li>
									<a href="entrepreneurs.php#ceos"><strong>CEO:</strong> George Berczely</a>
								</li>
								<li>
