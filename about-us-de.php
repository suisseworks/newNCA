...
-->
				...
				<div class="row no-gutters new_row mt-4">
					...
					<div class="col-lg-4 col-lg-4 member_card pl-5 pr-5 mb-10 mt-10 mt-lg-0">
                        ...
                        <div class="member_content bg-white py-4 d-flex align-items-center justify-content-center px-4">
                        	<div>
	                        	<h5 class="text-center font__size-22 line__height-30 font__family-efb">Meet<br> Aviv Harkov  </h5>
			        			<p class="text-center font__size-16 font__family-open-sans line__height-28 mt-2 member_status">
								Junior Analyst
			        			</p>
			        			<div class="d-flex align-items-center justify-content-center mt-3">
									<a href="https://www.linkedin.com/in/avivharkov/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-2"><i class="fab fa-linkedin-in"></i></a>
							    </div>							
						    </div>	
                        </div>	
					</div>
