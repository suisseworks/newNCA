				    ...
				    <div class="detail_searcher sbs_deatail mt-5 position-relative">
						<div class="member_content py-4">
                        	<div>
			        			...
			        			<p class="font__size-30 font__halvetica-bold line__height-50"><span class="pb-15 d-inline-block">NCA Entrepreneur</span><br><span class="font__size-41">2025</span> <span class=" member_count_arrow px-lg-3 pt-lg-12 pt-10 d-inline-flex">
			        			...
			        			</span><span class="font__size-41 ml-lg-0 ml-10">2027</span></p>	
								<p style="margin-top: 8px;  "> <a href="https://www.linkedin.com/in/teresa-diane-rupp-2b664a28/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5  mr-2"><i style="font-size: 20px;" class="fab fa-linkedin-in"></i></a>
								
						    </div>	
	                    </div>
	                    <h2 class="font__halvetica-bold text-uppercase font__size-133 line__height-160 position-relative"><span class="heading_bg">Teresa</span> <br> <sapn class="heading_bg_2">Rupp</sapn></h2>
				    </div>	
				</div>    
			</div>
			<div class="col-lg-8">
				<div class="searcher_image position-relative">
					<img class="w-100" src="img/teresa-rupp2.png">
				</div>	
			</div>	
		</div>
	...
	<div class="outer_container container-outer-1600 pb-lg-200 pb-50">
				...
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/about-me-teresa-rupp.png">
					...
					<div class="col-lg-5 pl-lg-20">
						<div class="image_text_div py-lg-0 py-4 h-100 font__halvetica-bold">
							...
							Originally from the Midwest of the United States, I began my career working across the US for global education companies in roles spanning strategy, operations, and product management. 
							</p>
							<p class="mt-30 font__size-16 font__halvetica-regular">
                            I moved to the UK in 2015 to lead a >50-country portfolio for Kaplan, a worldwide leader in training with >$1bn annual revenue. I then transitioned to working with SMEs across the UK and spanning all segments of the education industry - from edtech software, to apprenticeship training, to school suppliers - applying my expertise to drive top- and bottom-line growth.
							</p>
						</div>	
					</div>
					<div class="col-lg-2">
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/my-search-teresa-rupp.png">
							<div class="transform_div position-absolute">
					...
					<div class="col-lg-5 pl-lg-20">
						<div class="image_text_div py-lg-0 py-4 h-100 font__halvetica-bold">
							<p class="font-weight-bold font__size-16">
                            ​I am looking to acquire a UK-based SME in the education and training industry that I can lead through its next phase of growth, while recognising and maintaining the utmost respect for the leader, teams, and customers who brought the business to its current levels of success. 
							</p>
							<p class="mt-30 font__size-16 font__halvetica-regular">
                            Segments include providers of, and suppliers to: secondary education, post-secondary education, and primary / pre-primary education.
							</p>
						</div>	
					</div>
					<div class="col-lg-2">
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/my-contribution-teresa-rupp.png">
							<div class="transform_div position-absolute">
					...
					<div class="col-lg-5 pl-lg-20">
						<div class="image_text_div py-lg-0 py-4 h-100 font__halvetica-bold">
							<p class="font-weight-bold font__size-16">
                            ​I have taken both large companies and SMEs on transformation journeys to drive short- and long-term growth. 
							</p>
							<p class="mt-30 font__size-16 font__halvetica-regular">
                            Whether it is through entering new markets, redefining product portfolios, or navigating ever-changing regulatory environments, I look forward to working with those who already know the business well to create a strategy for sustainable growth, and fostering an empowered environment in which people thrive and take collective ownership over delivering outcomes for customers. 
							</p>
						</div>	
					</div>
					<div class="col-lg-2">
			...
			<div class="col-lg-8 pl-lg-20">
				<div class="video_div d-flex h-100 pt-lg-0 pt-50">
					<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
	                    <img src="img/thumbnail-rupp.png" alt="alt" class="image_video object-fit_cover w-100 h-100">
	                    <div class="sbs_btn play_button left_btn center_btn play_btn_white position-absolute">
		                    <a class="d-flex align-items-center fancybox" href="https://www.youtube.com/watch?v=gtXRwO-p3uw" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-18 font__family-open-sans">PLAY</span></a>
	                    </div>
	                </div>
				</div>	
			</div>	
		...
		<div class="row pt-50 pb-130">
			<div class="col-lg-4 pr-lg-20">
				<div class="learn_more_btns sbs_download_btn resume_btn pt-30 pb-30 pl-70 pr-70 d-flex justify-content-center">
					<a download href="docs/teresa-rupp-resume.pdf" type="button" class="pb-1 btn text-primary font-weight-bold text-left font__family-open-sans text-uppercase font__size-45 line__height-60 p-0 m-0">DOWNLOAD<br> RESUME
				...
				<div class="info_text sabastien_col mt-lg-0 mt-50 p-xs-0 pl-50 pr-50 pt-100 pb-100">
                    ...
                    <ul class="pl-0 mt-30">
                    	<li class="w-100 mb-30">
                    		<a class="font__halvetica-bold pr-50 text-white font__size-38" href="mailTo:teresa.rupp@novastone-ca.com">teresa.rupp@novastone-ca.com</a>
                    	</li>
                    </ul>
				</div>	
			</div>	
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-27 font__family-avenir text-capitalize line__height-70 text-white">Teresa Rupp</h1>
				...
				<div class="col-12 col-lg-5 text-lg-right">
					<div class="searcher_mail d-flex align-items-center justify-content-end mt-3 pt-1">
						<a href="mailTo:teresa.rupp@novastone-ca.com" class="font__size-17 text-brand-primary font__halvetica-bold font-weight-bold underline mr-3"><span>teresa.rupp@novastone-ca.com</span></a>
						<a href="https://www.linkedin.com/in/teresa-diane-rupp-2b664a28/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
