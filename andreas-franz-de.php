				...
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							<a href="https://www.linkedin.com/in/andreas-franz-emba" target="_blank" class="social_icon searcher_linkdin mt-100 d-inline-flex align-items-center ml-2 justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
							<a href="https://novastone-ca.com/andreas-franz.php" class="bg-transparent mt-110 ml-10 font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">English</a>
						</div>
					</div>	
					...
					<div class="detail_searcher mt-2">
						...
						<p class="font__size-18 line__height-24">Nachdem ich in Deutschland aufgewachsen bin, hatte ich die Möglichkeit, in Ländern auf der ganzen Welt wie den USA, Großbritannien, Russland, Österreich, der Schweiz und Italien zu studieren, zu arbeiten und zu leben. Meine Karriere war umfangreich und prägte mein internationales Managementprofil durch Tätigkeiten in der Strategieberatung, bei Mode- und Sportmarken, im Business Development, dem Konsumgütersektor sowie als Unternehmer. </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:andreas.franz@novastone-ca.com" type="button" class="btn text-white font__family-efb">Kontakt<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-50 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Ausgeprägte Neugier</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Strukturiertes Experimentieren</li>
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Teams aufbauen</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Innovative Denkweise</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">Mein Fokus liegt auf dem Erwerb eines Unternehmens der Konsumgüterindustrie in Deutschland, Österreich oder der Schweiz.</p>
					<p class="font__size-16 line__height-24 mt-2">Konkret suche ich KMU in den Segmenten Fashion & Lifestyle Goods, die trotz der Pandemiekrise gut performen und in ihrem Segment Vordenker sind. </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">Ich bin ein vielseitiger Professional mit über 25 Jahren Erfahrung und Know-how in der Entwicklung von Unternehmen im Fashion & Lifestyle.</p>
					<p class="font__size-16 line__height-24 mt-1">Für den Bereich Fashion & Lifestyle Goods sehe ich 5 Hebel, um Wertschöpfung zu kreieren und Wachstum im Zielunternehmen voranzutreiben: internationale Expansion, Entwicklung neuer Produkte, neue Vertriebskanäle, Leistungsverbesserung und Digitalisierung.  </p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:andreas.franz@novastone-ca.com">andreas.franz@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Wenn du ein Schiff bauen willst, trommle nicht die Männer zusammen, um Holz zu sammeln, die Arbeit einzuteilen und Befehle zu erteilen. Bringe ihnen stattdessen bei, sich nach dem weiten und endlosen Meer zu sehnen.</h4>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">Andreas Franz</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:andreas.franz@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">andreas.franz@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/andreas-franz-emba" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
