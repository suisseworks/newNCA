			...
			<div class="col-lg-4 main_text">
				...
				<div class="detail_main_col d-flex align-items-end h-100">
				    <div class="detail_searcher sbs_deatail mt-5 position-relative">
	                    ...
	                    <h2 class="font__halvetica-bold text-uppercase font__size-133 line__height-160 position-relative"><span class="heading_bg">WILLIAM</span> <br> <sapn class="heading_bg_2">HUNNAM</sapn></h2>
				    </div>	
				</div>    
			</div>
			<div class="col-lg-8">
				<div class="searcher_image position-relative">
					<img class="w-100" src="img/will.png">
				</div>	
			</div>	
		</div>
				...
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/card-cam.jpg">
...
For this search, it will be exciting to bring together my engineering and senior management experience, applying this to a single SME business with great growth potential. 
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/industrial.jpg">
							<div class="transform_div position-absolute">
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/machining.jpg">
							<div class="transform_div position-absolute">
			...
			<div class="col-lg-4 pr-lg-20">
				<div class="video_text about_contact_info pl-45 pr-30 pb-30 w-100 d-flex h-100 align-items-center">
					<div>
						...
						For, in the end, it is impossible to have a great life unless it is a meaningful life. <br> And it is very difficult to have a meaningful life without meaningful work.<br><br>							 
						</h2>
				...
				<div class="info_text sabastien_col mt-lg-0 mt-50 p-xs-0 pl-50 pr-50 pt-100 pb-100">
                    ...
                    <ul class="pl-0 mt-30">
                    	<li class="w-100 mb-30">
                    		<a class="font__halvetica-bold pr-50 text-white font__size-38" href="mailTo:will.hunnam@novastone-ca.com">will.hunnam@novastone-ca.com</a>
                    	</li>
                    </ul>
				</div>	
			</div>	
				...
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-27 font__family-avenir text-capitalize line__height-70 text-white">William Hunnam</h1>
