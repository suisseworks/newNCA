				...
				<div class="searcher_content pt-100 ml-4">
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							<a href="https://www.linkedin.com/in/vivanpinto/" target="_blank" class="social_icon searcher_linkdin mt-100 d-inline-flex align-items-center ml-2 justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
							 
						</div>
					</div>		
					<div class="detail_searcher mt-2">
						<h2 class="font__family-efb text-uppercase line__height-90">Vivan <br> Pinto</h2>
						...
						<p class="font__size-18 line__height-24"> I was born in India and grew up travelling the world, following my father’s international healthcare career. We lived in Tokyo, New York and London and I achieved a BSc at Duke University, North Carolina before completing a master’s degree in law, and an MBA here in London.  <br><br> I chose to work in consumer health, as I wanted to encourage people to have healthier lives through awareness and education. I rose up through the Marketing function in the UK, then moving to General Management in Sweden and Africa before returning home to the UK in 2022. When I arrived back in the UK, I became CEO of a healthcare company, which I thoroughly enjoyed before stepping down to support my father through his retirement in 2024.  

The next step for me is clear. My goal is to lead a Consumer Health company where I can ignite my passion to influence the health of the people in our community. </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:vivan.pinto@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-5032 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Strategic, agile mindset  </li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Focused on delivering results </li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Unlock the potential of the team</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Value diversity of people and thought </li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">I am committed to acquiring a Consumer Health company in the UK with a solid foundation in science. We will drive superior growth through professional management, strengthening the brand proposition, and influencing the trajectory of health and wellness in the community. Consumer Health encompasses medicines, diagnostics & e-health, and is growing as the population ages and consumers take control of their own health.  </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">I have a track record of 25 years in Consumer Health at leading international companies like J&J, Pfizer, and Reckitt and have had the privilege to lead a number of large brands in the UK such as Listerine, Nicorette, and Gaviscon. I developed and implemented a range of initiatives including regulatory switches, innovation launches, digital transformations, and key account partnerships. I have also led a healthcare SME specializing in infection control post the COVID pandemic in the UK as CEO.  </p>
					<p class="font__size-16 line__height-24 mt-1">I am a strong candidate to run an SME in consumer health where I can grow the brand, professionalise the organisation and drive a clear, agile growth plan.  </p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                    <img src="img/thumbnail-vivan-pinto5.png" alt="alt" class="image_video">
                    <div class="play_button left_btn center_btn play_btn_white position-absolute">
	                    <a class="d-flex align-items-center fancybox" href="https://youtu.be/sj8UmVAUR-4" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                    </div>
                </div>
			</div>
			<div class="col-lg-1"></div>
...
<section class="resume_sec searcher_bg">
	<div class="pt-150 pb-100">
		<div class="row no-gutters">
			...
			<div class="col-lg-8">
				<img src="img/vivan-pinto-background3.png" class="resume_img">
			</div>
		</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:vivan.pinto@novastone-ca.com">vivan.pinto@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Taking care of your health is one of the best investments you can make.</h4>
							<h5 class="font__size-23 line__height-35 font__family-open-sans font-weight-bold mt-3 text-uppercase">Sir Richard Branson</h5>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">VIVAN PINTO</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:vivan.pinto@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">vivan.pinto@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/vivanpinto/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
