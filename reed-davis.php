				...
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							<a href="https://www.linkedin.com/in/reed-davis-bb1070127/" target="_blank" class="social_icon searcher_linkdin mt-100 d-inline-flex align-items-center ml-2 justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					...
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:reed.davis@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-50 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Ideator</li>
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Relator</li>						
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Strategist</li>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:reed.davis@novastone-ca.com">reed.davis@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Management is the opportunity to help people become better people.</h4>
							<h5 class="font__size-23 line__height-35 font__family-open-sans font-weight-bold mt-3 text-uppercase">Clayton M. Christensen</h5>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">Reed Davis</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:reed.davis@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">reed.davis@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/reed-davis-bb1070127/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
