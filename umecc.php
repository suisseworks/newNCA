            ...
            <div class="col-lg-6">
                ...
                <div class="forza-heading">						                          		 
                        ...
                        <div class="forza-log desktop-logo text-left">
					      <a href="https://umecc.com/" target="_blank"><img style="" src="img/portfolio/umecc-logo.gif"></a>
				        </div>
                        <br> <br>
						<h4 class="mb-5 forza-subtitle subtitle wow fadeInUp">
                        UMECC provides a wide range of heavy-duty production equipment to the steel industry from the company’s global list of specialized- and qualified vendors.

						</h4>
						<p>
                        Founded in 1998, UMECC offers a comprehensive range of metallurgical equipment, spare parts, and refractories, to keep its customers focusing on what they are good at - making steel! . The company ensures technical excellence by conducting detailed assessments on every order and managing the entire fulfilment process: from engineering services and helping customers understand what they need, to manufacturing the correct products with in-process quality control,  to delivery at steel mills. With a focus on quality and timely delivery, UMECC is a trusted partner to some of the most renowned companies in the industry.<br><br><br><br><br><br><br>
						</p>	
					</div>
					<div class="col-12 visit-btn px-0 mt-5">
						<div class="d-flex align-items-center justify-content-center talent_btn_learn h-100 pb-lg-0 pb-sm-2 pl-lg-50">
								<a href="https://umecc.com/" target="_blank" class="social_icon d-inline-flex align-items-center h-100 justify-content-start border-radius-0 p-2 pl-50 text-white bg-primary w-100 text-uppercase">Visit Website</a>
							</div>
					</div>
				</div>	
			</div>	
