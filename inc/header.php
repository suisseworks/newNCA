				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="brk-header__item h-100 d-flex align-items-center justify-content-center">
							<a href="<?php echo $_SESSION['page'] ?>" class="bg-transparent font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">Deutsch</a>
