				...
				<div class="col-lg align-self-lg-stretch text-lg-right">
					...
					<nav class="brk-nav brk-header__item">
						...
						<ul class="brk-nav__menu">
							...
							<li class="home-menu d-xs-none"><a href="index.php">
									<div>Home</div>
								</a></li>
							...
							<li><a href="candidates.php">
									<div><span class="d-lg-none menu_for"></span>For Candidates</div>
								</a></li>
							...
							<li class="dropdown mo-li">
								...
								<a href="https://novastone-ca.com/blog/blog.php"><span class="d-lg-none menu_for">For</span>Insights
									<i class="fa fa-caret-down pl-1"></i>
								</a>
...
<div class="brk-theme-options form_side_bar bg-primary" data-brk-library="brk-customizer">
	...
	<div class="brk-theme-options__control shadow-none bg-primary get_touch_main">
		...
		<div class="zoho_form">
			...
			<script type="text/javascript" src="https://atds-zcmp.maillist-manage.eu/js/optin.min.js" onload="setupSF('sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5','ZCFORMVIEW',false,'acc',false,'2')">
			</script>
			<script type="text/javascript">
				function runOnFormSubmit_sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5(th) {};
			</script>
			<style>
				#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 #customForm *:not(.dateClass) {
				...
				#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 .dateClass {
				...
				@media only screen and (max-width: 319px) {
					#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 #signupMainDiv {
						width: 220px !important;
						min-width: 220px !important;
						margin: 0px auto !important;
					}

					#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 #SIGNUP_PAGE {
						padding: 0px !important
					}

					#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 [changeitem="SIGNUP_FORM_FIELD"] {
						width: 94% !important;
					}

					#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 .zcinputbox {
						width: 100% !important;
						max-width: 100% !important;
						float: none !important;
					}

					#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 #captchaDiv {
						width: 69.5% !important;
					}

					#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 #relCaptcha {
						margin-right: 11px !important;
					}

					#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 .recaptcha {
				...
				@media screen and (min-width: 320px) and (max-width: 580px) {
					...
					#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 #captchaText {
						width: 96% !important;
					}
					...
					#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 #capRequired {
				...
				/*** RESPONSIVE END */
				#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 .bdr_btm_hover {
					background-color: #f9f9f9;
					padding: 10px;
				}

				#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 .bdr_btm {
					padding: 10px
				}

				#sf3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5 .f14 {
					font-size: 14px
				}
			</style>
						...
						<div>
							<div name="" changeid="" changename="" style="margin:0px auto">
								<div id="imgBlock" name="LOGO_DIV" logo="true" style="width: 600px; margin: 0px auto; font-family: Arial, Helvetica, sans-serif; padding-bottom: 10px; color: rgb(68, 68, 68); text-align: center; padding-right: 10px; font-size: 12px; padding-top: 10px; font-weight: bold;">
									<img valign="middle" src="https://stratus.campaign-image.eu/images/14acc2d0fd_nca_logo_white_2.png" name="LOGO" id="iframeImg" style="width: 341px; max-width: 100%; height: auto;">
								</div>
							</div> <br>
							<div id="signupMainDiv" style="margin: 0px auto; width: 100%; min-width: 230px; max-width: 600px;" name="SIGNUPFORM" changeid="SIGNUPFORM" changename="SIGNUPFORM">
								<div>
									<div style="position:relative;">
										<div id="Zc_SignupSuccess" style="display:none;position:absolute;margin-left:4%;width:90%;background-color: white; padding: 3px; border: 3px solid rgb(194, 225, 154); margin-top: 10px;margin-bottom:10px;word-break:break-all">
											<table width="100%" cellpadding="0" cellspacing="0" border="0">
												<tbody>
													<tr>
														<td width="10%"> <img class="successicon" src="https://atds-zcmp.maillist-manage.eu/images/challangeiconenable.jpg" align="absmiddle"> </td>
														<td> <span id="signupSuccessMsg" style="color: rgb(73, 140, 132); font-family: sans-serif; font-size: 14px;word-break:break-word">&nbsp;&nbsp;Thank
									...
									<form method="POST" id="zcampaignOptinForm" style="margin:0px;" action="https://atds-zcmp.maillist-manage.eu/weboptin.zc" target="_zcSignup">
										<div id="SIGNUP_BODY_ALL" name="SIGNUP_BODY_ALL" style="border: none; padding: 0px;">
											...
											<div style="background-color: rgb(255, 255, 255); color: rgb(229, 114, 0); padding: 30px; font-family: &quot;Open Sans&quot;; border-radius: 30px; text-align: center; font-size: 14px; opacity: 1;" id="SIGNUP_BODY" name="SIGNUP_BODY">
												<div style="margin:0px auto;text-align:left;">
													<div style="line-height:1.6;" class="" changeid="SIGNUP_MSG" id="SIGNUP_DESCRIPTION" changetype="SIGNUP_DESCRIPTION">Please complete the
														form below to stay in touch via our quarterly newsletter. If you would like
														a member of our team to contact you, please leave a brief note so that we
														can forward you correctly.</div>
													...
													<div>
														<div style="font-size:12px; margin-top:10px;" name="fieldsdivSf" class="zcsffieldsdiv">
															<div style="padding:10px 0px 10px 0px;" class="zcsffield " fieldid="103402000011283041">
																<div style="">
																	<div style="position:relative">
																		<div style="color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 12px;" name="SIGNUP_FORM_LABEL">Select your profile&nbsp; <span name="SIGNUP_REQUIRED" style="color: rgb(180, 0, 0); font-family: Arial, Helvetica, sans-serif; font-size: 11px;">*</span>
																		</div> <select name="CONTACT_CF1" changeitem="SIGNUP_FORM_FIELD" style="width: 97%; color: rgb(229, 114, 0); background-color: rgb(235, 235, 235); border: 2px solid rgb(229, 114, 0); padding: 3px; background-attachment: scroll; background-image: url(&quot;data:image/png&quot;); box-sizing: border-box; text-indent: 15px; outline: 0px; font-family: &quot;Open Sans&quot;; border-radius: 24px; background-size: 16px 18px; font-size: 14px; background-position: 98% 50%; background-repeat: no-repeat; height: 42px;" zc_display_name="Select your profile">
																			<option value="Candidate">Candidate</option>
																			<option value="Co-Investor">Co-Investor</option>
																			<option value="Business Owner">Business Owner</option>
																			<option value="Intermediary">Intermediary</option>
																			<option value="Other">Other</option>
																		</select>&nbsp; <span style="display:none" id="dt_CONTACT_CF1">1,true,3,Select your
																			profile,2</span>
																	</div>
																</div>
															...
															<div style="padding:10px 0px 10px 0px;" class="zcsffield " fieldid="103402000000000015">
																<div style="">
																	<div style="color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 12px;" name="SIGNUP_FORM_LABEL">E-mail&nbsp;<span name="SIGNUP_REQUIRED" style="color: rgb(180, 0, 0); font-family: Arial, Helvetica, sans-serif; font-size: 11px;">*</span>
																	</div>
															...
															<div style="padding:10px 0px 10px 0px;" class="zcsffield " fieldid="103402000000000019">
																<div style="">
																	<div style="color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 12px;" name="SIGNUP_FORM_LABEL">First Name&nbsp;<span name="SIGNUP_REQUIRED" style="color: rgb(180, 0, 0); font-family: Arial, Helvetica, sans-serif; font-size: 11px;">*</span>
																	</div>
																	<div style="width:100%; min-width:170px; margin-top:5px;">
																		<!-- check to mark emailid field as type email, and other mandatory fields as type required -->
																		<input name="FIRSTNAME" changeitem="SIGNUP_FORM_FIELD" style="width: 97%; color: rgb(229, 114, 0); background-color: rgb(235, 235, 235); border: 2px solid rgb(229, 114, 0); padding: 3px; background-attachment: scroll; background-image: url(&quot;data:image/png&quot;); box-sizing: border-box; text-indent: 15px; outline: 0px; font-family: &quot;Open Sans&quot;; border-radius: 24px; background-size: 16px 18px; font-size: 14px; background-position: 98% 50%; background-repeat: no-repeat; height: 42px;" maxlength="100" type="text" required="true" value="">
															...
															<div style="padding:10px 0px 10px 0px;" class="zcsffield " fieldid="103402000000000021">
																<div style="">
																	<div style="color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 12px;" name="SIGNUP_FORM_LABEL">Last Name&nbsp;<span name="SIGNUP_REQUIRED" style="color: rgb(180, 0, 0); font-family: Arial, Helvetica, sans-serif; font-size: 11px;">*</span>
																	</div>
																	<div style="width:100%; min-width:170px; margin-top:5px;">
																		<!-- check to mark emailid field as type email, and other mandatory fields as type required -->
																		...
																		<span style="display:none" id="dt_LASTNAME">1,true,1,Last
																			Name,2</span>
																	</div>
																</div>
																<div style="clear:both"></div>
															...
															<div style="padding:10px 0px 10px 0px;" class="zcsffield " fieldid="103402000019337299">
																<div style="">
															...
															<div style="padding:10px 0px 10px 0px;" class="zcsffield " fieldid="103402000000401621">
																<div style="">
																	<div>
																		<div style="float: left; margin-top: 5px; margin-right: 20px; font-family: Arial, Helvetica, sans-serif; color: rgb(51, 51, 51); font-size: 12px;" name="SIGNUP_FORM_LABEL">Newsletter&nbsp;<span name="SIGNUP_REQUIRED" style="color: rgb(180, 0, 0); font-family: Arial, Helvetica, sans-serif; font-size: 11px;">*</span>
																		</div>
														...
														<div id="REQUIRED_FIELD_TEXT" changetype="REQUIRED_FIELD_TEXT" name="SIGNUP_REQUIRED" style="color: rgb(180, 0, 0); padding: 10px 10px 10px 0px; font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
															*Required Fields</div>
														<div name="privacyPolicy" style=" padding:10px;width:100%;position:relative"> <input type="checkbox" style="vertical-align:middle" name="PRIVACY_POLICY" value="PRIVACY_AGREED"> <span style="vertical-align:middle;margin-left:5px">I agree to the&nbsp;
																<a href="https://www.novastone-ca.com/img/NCA-Privacy-Policy.pdf" target="_blank" style="text-decoration:none">Privacy
																	Policy</a>&nbsp;&nbsp;&nbsp;</span> </div>
														<div style="padding:10px; text-align:center;"> <input type="button" action="Save" id="zcWebOptin" name="SIGNUP_SUBMIT_BUTTON" changetype="SIGNUP_SUBMIT_BUTTON_TEXT" style="cursor: pointer; color: rgb(255, 255, 255); background-color: rgb(229, 114, 0); white-space: normal; border: 1px none rgb(49, 121, 206); padding: 9px 28px; text-align: center; outline: none medium; appearance: none; font-family: &quot;Open Sans&quot;; border-radius: 24px; width: 100%; font-size: 20px; background-position: center bottom; background-repeat: repeat-x;" value="SEND NOW!"> </div>
														<!-- Do not edit the below Zoho Campaigns hidden tags --> <input type="hidden" id="fieldBorder" value=""> <input type="hidden" name="zc_trackCode" id="zc_trackCode" value="ZCFORMVIEW" onload="">
														<input type="hidden" name="viewFrom" id="viewFrom" value="URL_ACTION">
														<input type="hidden" id="submitType" name="submitType" value="optinCustomView"> <input type="hidden" id="lD" name="lD" value="116f5b9237bdd4c9"> <input type="hidden" name="emailReportId" id="emailReportId" value=""> <input type="hidden" name="zx" id="cmpZuid" value="14acc2d0fd"> <input type="hidden" name="zcvers" value="2.0">
														<input type="hidden" name="oldListIds" id="allCheckedListIds" value="">
														<input type="hidden" id="mode" name="mode" value="OptinCreateView"> <input type="hidden" id="zcld" name="zcld" value="116f5b9237bdd4c9"> <input type="hidden" id="zctd" name="zctd" value="116f5b923710fdc1"> <input type="hidden" id="document_domain" value=""> <input type="hidden" id="zc_Url" value="atds-zcmp.maillist-manage.eu"> <input type="hidden" id="new_optin_response_in" value="1"> <input type="hidden" id="duplicate_optin_response_in" value="1"> <input type="hidden" id="zc_formIx" name="zc_formIx" value="3za771df9d7a89845721ea8b7b0ca4e980aaba066979255225ff4a4b49c8c4eea5"><!-- End of the campaigns hidden tags -->
													</div>
												</div> <input type="hidden" id="isCaptchaNeeded" value="false"> <input type="hidden" id="superAdminCap" value="0"> <img src="https://atds-zcmp.maillist-manage.eu/images/spacer.gif" onload="referenceSetter(this)" id="refImage" style="display:none;">
											</div>
											<div style="margin: 0px auto;margin-top:20px;text-align:left;height:76px;" id="privacyNotes" identity="privacyNotes"> <span>Note: It is our responsibility to
													protect your privacy and we guarantee that your data will be completely
			...
			<div id="zcOptinSuccessPopup" style="display:none;z-index: 9999;width: 800px; height: 40%;top: 84px;position: fixed; left: 26%;background-color: #FFFFFF;border-color: #E6E6E6; border-style: solid; border-width: 1px; box-shadow: 0 1px 10px #424242;padding: 35px;">
				<span style="position: absolute;top: -16px;right:-14px;z-index:99999;cursor: pointer;" id="closeSuccess"> <img src="https://atds-zcmp.maillist-manage.eu/images/videoclose.png"> </span>
