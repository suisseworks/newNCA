				...
				<div class="row">
					...
					<div class="col-12 col-sm-4 col-lg-3 col-xs-12">
						<div class="d-flex align-items-center justify-content-right">
							...
							<a href="https://www.linkedin.com/company/novastone-capital-advisors/" class="social_icon h-100 d-inline-flex align-items-center border-radius-5 p-1"><i class="fab fa-linkedin-in"></i></a>
