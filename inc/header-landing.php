...
<head>
	...
	<style>
		.brk-button-shadow {
			-webkit-box-shadow: 0 10px 15px rgba(0, 0, 0, .07) !important;
...
})(window,document,'script','dataLayer','GTM-MHG7P3C');</script>
	...
	<div class="main-page landing-page">
		<div class="brk-header-mobile">
			...
			<div class="brk-header-mobile__logo"><a href="index.php"><img class="brk-header-mobile__logo-1 lazyload"
						src="img/logo.png" data-src="img/nca_logo.png" alt="alt"> <img
						class="brk-header-mobile__logo-2 lazyload" src="img/logo.png" data-src="img/logo.png"
						alt="alt"></a></div>
		</div>
		<header
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-1 align-self-lg-center d-none d-lg-flex">
							...
							<a href="index.php" class="brk-header__logo brk-header__item @@modifier"><img
									class="brk-header__logo-1 lazyload" src="img/logo.png" data-src="img/logo.png"
									alt="alt"> <img class="brk-header__logo-2 lazyload" src="img/logo.png"
									data-src="img/logo.png" alt="alt"></a>
