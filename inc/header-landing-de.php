...
<head>
	...
	<meta name="description" content="NCA Business">
			...
			<div class="brk-header__main-bar order-lg-2 order-1" style="height: 72px;">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-10 align-self-lg-center landing_page_header justify-content-center d-none d-lg-flex">
						...
						<div class="brk-header__item d-flex landing_lng justify-content-center">
							<a href="#" class="bg-transparent btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">Deutsch</a>
						</div>
						</div>
					</div>
				</div>
