	...
	<div class="row no-gutters">
		<div class="col-lg-6">
			<div class="searcher_jan_img">
				<img src="img/nell-smircina-about.png">
			</div>
		</div>
				...
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							<a href="https://www.linkedin.com/in/dr-nell-smircina-10094267/" target="_blank" class="social_icon searcher_linkdin mt-100 d-inline-flex align-items-center ml-2 justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					...
					<div class="detail_searcher mt-2">
						<h2 class="font__family-efb text-uppercase line__height-90">Nell <br> Smircina</h2>
						...
						<p class="font__size-18 line__height-24"> 
                          I grew up outside of Washington, DC, always an athlete and obsessed with learning and growing. My introduction to healthcare was early, having suffered from sports injuries since age 5, and by my 20’s, I had a firsthand account of what works and what does not work in healthcare. After being introduced to something that did truly work, acupuncture, I set out to enter the field as a Licensed Acupuncturist in Beverly Hills, CA, which allowed me to address all aspects of health affecting injury or recovery, while tackling entrepreneurship in an incredibly competitive city.
                          It was this experience with the business of private practice, educating other practitioners and business owners, and then advocacy work which led me to truly see where the holes in the system were. I became a passionate speaker and advisor in integrative health, leaning into my love of business with broader consulting and my Executive MBA. There is such an exciting opportunity in this industry to dramatically impact not only health outcomes, but also business growth.
                        </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:nell.smircina@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-50 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Integrative Health Advocate</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Win-Win Curator</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Strategic Vision</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Agility & Resilience</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Disruptive Entrepreneurship</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">  
                      I am looking for a private, established integrative health business, which needs strategic vision and management for it’s next phase of elevated growth.
                     
					<p class="font__size-16 line__height-24 mt-2">Ultimately, it is about finding a company where values align, such as supporting the global initiative of whole person health. This company will operate in an area where conventional healthcare and health and wellness converge. Initially, we are looking at complementary and integrative products and services which support progressive healthcare providers and end users: herbal and dietary supplements, and multidisciplinary clinics and wellness centers.  </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">Leveraging not only my network to create meaningful strategic partnerships and growth opportunities, but also my experience with operational improvements and optimal team building and buy-in, I’m excited to use my background to bring a business to its next stages of growth.    </p>
					<p class="font__size-16 line__height-24 mt-1">I love this industry and have experience with all the major levers in both conventional healthcare and health and wellness: clinical, financial, regulatory and policy. My experience as a business owner and consultant in this very arena has allowed me to see behind the curtain for many of these types of companies already. My background in risk management and expertise as an advocate in this space gives me a leg up in a critical way: the integrative health industry is constantly evolving, and policy and regulation foresight can dramatically impact the future of these businesses.   </p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                        ...
                        <a class="d-flex align-items-center fancybox" href="https://youtu.be/4_2q9CJPmBE?si=W1n2ABupVoQqSwz2" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                        </div>
                     </div>
			</div>
			<div class="col-lg-1"></div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4 bg-white">
				...
				<div class="learn_more_btns resume_btn bg-primary pt-60 pb-60 pl-100 pr-100">
						<a download href="docs/" type="button" class="pb-1 btn text-white d-inline-flex align-items-center text-uppercase font__size-20 p-0 m-0">DOWNLOAD CURRICULUM VITAE<span class="ml-5 d-flex"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="38" height="38" viewBox="0 0 38 38">
								  <defs>
								    <clipPath id="clip-path">
								      <rect width="38" height="38" fill="none"/>
								    </clipPath>
			...
			<div class="col-lg-8">
				<img src="img/background-nell-smircina.png" class="resume_img">
			</div>
		</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:nell.smircina@novastone-ca.com">nell.smircina@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">What got you here won’t get you there</h4>
							<h5 class="font__size-23 line__height-35 font__family-open-sans font-weight-bold mt-3 text-uppercase">Marshall Goodman (Executive Coach and Author, on the importance of continued personal and professional growth)</h5>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">Nell Smircina </h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:nell.smircina@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">nell.smircina@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/dr-nell-smircina-10094267/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
