		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                        <img src="img/thumbnail-nell.png" alt="alt" class="image_video">
                        <div class="play_button left_btn center_btn play_btn_white position-absolute">
                        <a class="d-flex align-items-center fancybox" href="https://youtu.be/AfH201oJ1Jk?si=1rT93RiPKAmZnP6O" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                        </div>
                     </div>
			</div>
			<div class="col-lg-1"></div>
...
<section class="resume_sec searcher_bg">
	<div class="pt-150 pb-100">
		<div class="row no-gutters">
			...
			<div class="col-lg-8">
				<img src="img/background-nell_smircina.png" class="resume_img">
			</div>
		</div>
