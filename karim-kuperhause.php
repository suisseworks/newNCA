	...
	<div class="row no-gutters">
		<div class="col-lg-6">
			<div class="searcher_jan_img">
				<img src="img/karim-kuperhause.png">
			</div>
		</div>
				...
				<div class="searcher_content pt-100 ml-4">
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							<a href="https://www.linkedin.com/in/karimkuperhause/" target="_blank" class="social_icon searcher_linkdin mt-100 d-inline-flex align-items-center ml-2 justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
							 
						</div>
					</div>		
					<div class="detail_searcher mt-2">
						<h2 class="font__family-efb text-uppercase line__height-90">Karim <br> Kuperhause</h2>
						...
						<p class="font__size-18 line__height-24"> I was born in Quebec City but raised in Montreal, Ottawa and Toronto in an entrepreneurial family. Not wanting to follow in my father’s footsteps, I returned to Montreal to pursue my Bachelor of Education at McGill University and became a public-school teacher for 12 years. 

 
<br><br>
However, my entrepreneurial DNA never left me, so I founded and built an educational services company. I then transitioned into sales for EdTech and based on my success, went on to introduce 13 IT solutions into various markets ranging from RegTech to HRIS to FinTech to IT services, in both Canada and the US. I am looking to bring all my acquired skills, experience and knowledge to lead a Managed Service Provider or IT Professional Services Company in Quebec or Ontario.  </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:karim.kuperhause@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-5032 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Self Starter</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Highly Driven </li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Dedicated </li>
			...
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb"> I am focused on purchasing a Managed Service Provider (MSP) or IT Professional Services Company, possibly facing succession issues, which would benefit from sales and management expertise to drive growth.  </p>
					<p class="font__size-16 line__height-24 mt-2">More and more, companies are offloading their IT services to third parties to focus on their core activities. Engaging with an MSP allows them to save time, money, and resources while mitigating regulatory, compliance and privacy risks. 
<br>
I am looking for a company that has proven it can support IT services for companies of all sizes and where I see I can provide a meaningful impact to foster sustainable growth. </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb"> I am committed to both ensuring the legacy of the company being acquired and increasing value. For me, value creation is based on three pillars: customers, employees, and shareholder value. It starts with value creation for employees. If you solve for that, everything downstream takes care of itself.   </p>
					<p class="font__size-16 line__height-24 mt-1">A strong workforce will create value for customers and with a strong customer base, you create value for shareholders.   </p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                    <img src="img/thumbnail-karim.png" alt="alt" class="image_video">
                    <div class="play_button left_btn center_btn play_btn_white position-absolute">
	                    <a class="d-flex align-items-center fancybox" href="https://youtu.be/OeZtHs0N0hE" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                    </div>
                </div>
			</div>
			<div class="col-lg-1"></div>
...
<section class="resume_sec searcher_bg">
	<div class="pt-150 pb-100">
		<div class="row no-gutters">
			...
			<div class="col-lg-8">
				<img src="img/background-karim.png" class="resume_img">
			</div>
		</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:karim.kuperhause@novastone-ca.com">karim.kuperhause@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Trust but verify.</h4>
							<h5 class="font__size-23 line__height-35 font__family-open-sans font-weight-bold mt-3 text-uppercase">Russian proverb</h5>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">KARIM KUPERHAUSE</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:karim.kuperhause@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">karim.kuperhause@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/karimkuperhause/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
