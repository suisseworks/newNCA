				...
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							...
							<a href="http://novastone-ca.com/nicoletta-nutrito-en.php" class="bg-transparent mt-110 ml-10 font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">English</a>
						</div>
					</div>	
