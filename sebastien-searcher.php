		...
		<div class="row  pt-70 pb-100">
			<div class="col-lg-3 main_text">
			    <div class="key_skill key_skill_new position-relative pl-90 pr-50 pb-80 pt-50 ml-40">
				    <h2 class="d-flex align-items-center justify-content-center text-uppercase font__family-efb line__height-70 text-brand-primary"><a href="#" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 sabs_linkdin p-2 mr-2"><i class="fab fa-linkedin-in"></i></a> FIND ME ON LINKEDIN</h2>
				</div>	
				<div class="detail_searcher mt-5">
					<h2 class="font__family-efb text-uppercase font__size-150 line__height-130 bg-white">SÉBASTIEN <br> PERROUD</h2>
					<div class="member_content py-4 px-4">
                        	<div>
	                        	
			        			<p class="font__size-28 font__family-open-sans line__height-50">NCA Unternehmer<br>20 <span class=" member_count_arrow px-3 pt-12 d-inline-flex">
			...
			<div class="col-12 col-lg-12 px-2">
				<div class="sabastien_col wow fadeInRight w-100 apply_sec_div">
					<a href="#" class="d-block p-5 text-white sercher_clr_div">
						...
						<p class="font__size-25 mb-2 mt-4 font__family-open-sans font__weight-500">NCA Unternehmer</p>
				...
				<div class="col-lg-4">
					<div class="image_content_div position-relative">
						...
						<div class="transform_div position-absolute bg-dark">
							<p class="text-white py-2 px-3">ÜBER MICH</p>
						</div>
					</div>	
				</div>
				<div class="col-lg-5">
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="image_content_div position-relative">
						...
						<div class="transform_div position-absolute bg-dark">
							<p class="text-white py-2 px-3">MEINE SUCHE</p>
						</div>
					</div>	
				</div>
				<div class="col-lg-5">
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="image_content_div position-relative">
						...
						<div class="transform_div position-absolute bg-dark">
							<p class="text-white py-2 px-3">MEIN BEITRAG</p>
						</div>
					</div>	
				</div>
				<div class="col-lg-5">
			...
			<div class="col-lg-8">
				<div class="video_div">
					<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
	                    <img src="img/sabastein_thumb.png" alt="alt" class="image_video w-100">
		...
		<div class="row pt-50 pb-100">
			<div class="col-lg-4">
				<div class="learn_more_btns resume_btn bg-dark pt-60 pb-60 pl-100 pr-100 d-flex">
					<a download href="img/Jan-Nikolaisen-resume.pdf" type="button" class="pb-1 btn text-primary d-inline-flex align-items-center text-uppercase font__size-30 line__height-40 p-0 m-0">DOWNLOAD<br> LEBENSLAUF
			...
			<div class="col-lg-8">
				<div class="info_text sabastien_col  p-5">
                    <h2 class="text-uppercase text-white">
                    	MEINE KONTAKTDETAILS
                    </h2>
                    <ul class="pl-0 mt-30">
                    	<li class="w-100 mb-30">
                    		<a class="pr-50 text-white font__size-25" href="mailTo:sebastien.perroud@novastone-ca.com">sebastien.perroud@novastone-ca.com</a>
                    	</li>
                    </ul>
				</div>	
			</div>	
