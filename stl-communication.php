		...
		<div class="row no-gutters">
			...
			<div class="col-lg-6 bg-white">
                ...
                <div class="forza-list mt-5 text-center">
							<ul>
								<li>
									<strong>Headquarters:</strong> Chesterfield, MO, USA
								</li>
								<li>
									<a href="entrepreneurs.php#ceos"><strong>CEO:</strong> Nick Akers</a>
								</li>
								<li>
		...
		<div class="row">
			<div class="col-4 mbw-15">
				<div class="text-left prev-next-text">
				   <a href="chapter-one.php" class="text-uppercase underline m-underline">< <span class="m-company">Previous Company</span></a>
				</div>   
			</div>
			...
			<div class="col-4 mbw-15">
				<div class="text-right prev-next-text">
				   <a href="water-runner.php" class="text-uppercase underline m-underline"><span class="m-company">Next Company</span> ></a>
				</div>   
			</div>	
		</div>	
	</div>	
