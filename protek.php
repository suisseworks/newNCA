		...
		<div class="row no-gutters">
            ...
            <div class="col-lg-6">
                ...
                <div class="forza-heading">						                          		 
                        ...
                        Protek is a Canadian-based company specializing in providing vehicular electricity solutions and upfitting services.
					...
					<div class="col-12 visit-btn px-0 mt-5">
						<div class="d-flex align-items-center justify-content-center talent_btn_learn h-100 pb-lg-0 pb-sm-2 pl-lg-50">
								<a href="hhttps://covepro.ca/" target="_blank" class="social_icon d-inline-flex align-items-center h-100 justify-content-start border-radius-0 p-2 pl-50 text-white bg-primary w-100 text-uppercase">Visit Website</a>
							</div>
					</div>
				</div>	
			</div>	
