...
<section class="searcher_sectain searcher_bg">
	<div class="row no-gutters">
		...
		<div class="col-lg-6 pr-0">
				<div class="searcher_content pt-80 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							...
							<a href="http://novastone-ca.com/ben-boenk.php" class="bg-transparent mt-110 ml-10 font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">English</a>
						</div>
					</div>	
					...
					<div class="detail_searcher mt-2">
						...
						<h4 class="font__size-38 mt-4">NCA Ondernemer</h4>
						...
						<p class="font__size-18 line__height-24"><b style="font-weight: bold;">Ik ben, tot op heden, actief geweest in twee hoofdcategorieen: 18 jaar als oprichter en directeur van een zeer succesvol en high-end catering- en evenementenmanagement bedrijf in Nederland en 17 jaar als mede-oprichter en CEO van verschillende bedrijven in producten voor baby's en kleine kinderen in het Midden-Oosten. </b> </br>

						Als volgende stap in mijn carrière wil ik mijn passie, kennis en internationale ervaring toepassen in de Benelux en een bedrijf, in een van de categorieën van mijn zoektocht, naar een volgende fase leiden. Ik ben zeer enthousiast om dit samen te doen met het getalenteerde en gemotiveerde team van Novastone Capital Advisors.  
						Ook buiten mijn werk ben ik altijd geïnteresseerd in ondernemerschap en coach ik anderen om hun doelen te bereiken. Ik ben vader van twee studerende kinderen en hou van zeilen, golfen en koken. </br></br>
</p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-0">
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					<h2 class="font__size-58 text-uppercase text-brand-primary font__family-efb line__height-90" id="my_search_heading">Mijn zoekopdracht </h2>
					<p class="font__size-16 line__height-24 font__family-efb">De focus van mijn zoektocht is een winstgevend MKB bedrijf in een van de volgende drie categorieën: 
												<ul class="mt-2 ml-5 pl-4" style="list-style: circle;">
													<li>Productie en distributie van gezond voedsel en dranken   </li>
													<li>Vrije tijdsbesteding, entertainment, wellness, vakantie </li>
													<li>Produkten en diensten voor babies en kleine kinderen  </li>
												</ul>
										 </p>
					<p class="font__size-16 line__height-24 mt-2">Vooral in deze sectoren kan ik mijn 34 jaar ondernemerservaring als beste benutten en kan ik optimaal profiteren van mijn vaardigheden, achtergrond en netwerk. 

</p>

					<h2 class="font__size-58 text-uppercase text-brand-primary font__family-efb line__height-90 mt-5" id="my_search_heading">Mijn bijdrage </h2>
					<p class="font__size-16 line__height-24 font__family-efb"> 

					Ik heb aantoonbaar en langdurig top-managementervaring in verschillende bedrijfstakken, Ik richt mij hierbij op het aansturen van het team richting  internationale groei,  innovatie in product en service en verbetering van processen. Ik geloof in kwaliteit in alles wat we doen. 

</p>
					<p class="font__size-16 line__height-24 mt-1"> Door de vele jaren die ik actief ben als ondernemer heb ik sterke operationele ervaring opgedaan in de dagelijkse bedrijfsvoering, maar ook in de implementatie van nieuwe strategieën. Ik heb bedrijven door verschillende groeifasen en ook crises geleid: deze waardevolle ervaringen hebben mij geleerd om bedrijven naar uiteindelijk succes te sturen en me niet te laten afleiden door de onvermijdelijke conjuncturele schommelingen.  

 

</br></br>Ik gaf leiding aan grote multiculturele teams en heb verschillende fusies en overnames geleid. Ik ben van nature creatief en goed in het oplossen van problemen. Door mijn achtergrond in de gastvrijheidsindustrie heb ik altijd een sterke focus op het overtreffen van de verwachtingen van de klant, terwijl mijn jarenlange ervaring in Retail en Distributie mij geleerd heeft om sterk op de marges te letten.  </p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                        ...
                        <a class="d-flex align-items-center fancybox" href="https://youtu.be/XsWXAYKMbyw" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                        </div>
                     </div>
			</div>
			<div class="col-lg-1"></div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4 bg-white">
				<div class="about_learn pt-100 pb-80 pl-100 pr-100">
					...
					<h3 class="font__family-efb font__size-30 text-white line__height-52 mt-2">NCA Ondernemer</h3>
					<p class="font__size-17 line__height-24 mt-2 text-white font__family-open-sans">Het NCA Entrepreneurship Through Acquisition Program begeleidt de volgende generatie uitzonderlijke talenten in elke fase van hun ondernemerstraject.</p>
					<div class="learn_more_btns learn_about_btn mt-5 mb-4 pb-2">
						<a href="about-us.php" target="__blank" type="button" class="btn text-white text-uppercase font__size-24 p-0 d-flex align-items-center m-0">LEER MEER<span class="ml-5 d-flex"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="38" height="38" viewBox="0 0 38 38">
							  <defs>
							    <clipPath id="clip-path">
				...
				<div class="learn_more_btns resume_btn bg-primary pt-60 pb-60 pl-100 pr-100">
						<a download href="docs/Ben-Boenk-resume.pdf" type="button" class="pb-1 btn text-white d-inline-flex align-items-center text-uppercase font__size-20 p-0 m-0">Curriculum vitae downloaden<span class="ml-5 d-flex"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="38" height="38" viewBox="0 0 38 38">
								  <defs>
								    <clipPath id="clip-path">
								      <rect width="38" height="38" fill="none"/>
								    </clipPath>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					<h2 class="font__family-efb text-uppercase mb-3">MIJN CONTACTGEGEVENS</h2>
			...
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">De meest effectieve manier om iets te doen, is om het te doen.</h4>
				...
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							...
							<h3 class="font__size-17 ml-3 font__family-open-sans text-white">NCA Ondernemer</h3>
						</div>
