		...
		<div class="row no-gutters">
            ...
            <div class="col-lg-6 bg-white">
                ...
                <div class="forza-list mt-5 text-center">
							<ul>
								...
								<li>
									<a href="entrepreneurs.php#ceos"><strong>CEO:</strong>Paolo Ciarlariello</a>
								</li>
								<li>
									<strong>In NCA portfolio since:</strong> September 2024
								</li>
							</ul>                
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="forza-heading">						                          		 
                        ...
                        Marcona3 is a Milan based agent and distributor of emerging luxury brands.

						</h4>
						<p>
                        Marcona3 is a leading showroom specializing in the global distribution of both emerging and established luxury brands.  The company excels in coordinating sales, services, and brand communication. Buyers from all over the world, come to Milan and Paris during the fashion weeks to visit Marcona3 for new and uprising brands. Since its founding in 2001, Marcona3 has become one of Italy's most prominent showrooms, with a second location in Paris. <br><br><br><br><br><br><br>
						</p>	
					</div>
					<div class="col-12 visit-btn px-0 mt-5">
						<div class="d-flex align-items-center justify-content-center talent_btn_learn h-100 pb-lg-0 pb-sm-2 pl-lg-50">
								<a href="https://www.marcona3.com/" target="_blank" class="social_icon d-inline-flex align-items-center h-100 justify-content-start border-radius-0 p-2 pl-50 text-white bg-primary w-100 text-uppercase">Visit Website</a>
							</div>
					</div>
				</div>	
			</div>	
