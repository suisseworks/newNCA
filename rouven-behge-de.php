			...
			<div class="row align-items-center mt-30">
				...
				<div class="col-lg-4 col-sm-12 col-12 col-xs-12">
					<ul class="copyright_menu d-inline-flex brk-white-font-color font__size-12 font__family-open-sans font-weight-bold">
						<li><a href="img/Terms-and-Conditions-Legal Notice.pdf" download="">Allgemeine Geschäftsbedingungen</a></li>
						<li><a href="img/NCA-Privacy-Policy.pdf" download="">Datenschutzrichtlinie</a></li>
					</ul>
				</div>
