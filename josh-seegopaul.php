	...
	<div class="row no-gutters">
		<div class="col-lg-6">
			<div class="searcher_jan_img">
				<img src="img/josh_seegopaul.png">
			</div>
		</div>
				...
				<div class="searcher_content pt-100 ml-4">
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							<a href="https://www.linkedin.com/in/seegopaul/" target="_blank" class="social_icon searcher_linkdin mt-100 d-inline-flex align-items-center ml-2 justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
							 
						</div>
					</div>		
					<div class="detail_searcher mt-2">
						<h2 class="font__family-efb text-uppercase line__height-90">Josh  <br> Seegopaul</h2>
						...
						<p class="font__size-18 line__height-24"> I was born in Australia and raised in the United States, where I live with my wife and two children. My 20+ year career includes a uniquely diverse journey across high-impact Executive Operations, New Venture Leadership, Enterprise Strategy, M&A and Private Equity Value Creation. I’ve worked in numerous sectors including Professional Business Services, Healthcare and Finance and have always gravitated towards dynamic environments with ambitious growth plans. <br> <br> </p>

                         <p class="font__size-18 line__height-24"> My passion is working hard with incredible teammates towards solving challenging problems and achieving outlier goals. </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:josh.seegopaul@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-5032 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Honesty & Integrity</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Leader & Collaborator </li>
			...
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">With the support of Novastone and its investors, I’m looking to acquire an established business providing critical Professional Business Services to a growing customer base within the United States. I am particularly interested in companies with an intense customer focus and a culture of product or service excellence that provides a foundation for sustainable growth in the future.   </p>
					<p class="font__size-16 line__height-24 mt-2">My unique background and proven track record at the intersection of growth, turnaround, technology and team management positions me well to lead a strong established business to its next stage of innovative growth.  </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">Throughout my career, I’ve grown businesses while retaining organizational excellence, innovative product differentiation and unwavering customer focus. I’ve executed outlier growth and Go-to-Market playbooks across a myriad of company stages and profiles with a focus on high-performing collaborative and cohesive teams.  </p>
					<p class="font__size-16 line__height-24 mt-1">My experience in world-class team cultures enables me to build and lead environments where each individual has an opportunity to meaningfully contribute to the company mission. This is a critical element of business success, right alongside profitable growth.</p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                    <img src="img/thumbnail-josh.png" alt="alt" class="image_video">
                    <div class="play_button left_btn center_btn play_btn_white position-absolute">
	                    <a class="d-flex align-items-center fancybox" href="https://youtu.be/Au3MvF6Y6IY" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                    </div>
                </div>
			</div>
			<div class="col-lg-1"></div>
...
<section class="resume_sec searcher_bg">
	<div class="pt-150 pb-100">
		<div class="row no-gutters">
			...
			<div class="col-lg-8">
				<img src="img/josh_background.png" class="resume_img">
			</div>
		</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:josh.seegopaul@novastone-ca.com">josh.seegopaul@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">I’m convinced that about half of what separates the successful entrepreneurs from the non-successful ones is pure perseverance.</h4>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">Josh Seegopaul</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:josh.seegopaul@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">josh.seegopaul@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/seegopaul/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
