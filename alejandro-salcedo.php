	...
	<div class="row no-gutters">
		<div class="col-lg-6">
			<div class="searcher_jan_img">
				<img src="img/alejandro-salcedo.png">
			</div>
		</div>
		<div class="col-lg-6 pr-0">
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="detail_searcher mt-2">
						...
						<p class="font__size-18 line__height-24">As an international leader with over 20 years of experience in the high-tech and healthcare industries, I come with a strong background in sales, marketing and management experience. I was born and raised in Mexico, where I received my degree in mechanical & electrical engineering. I then lived in 6 countries and made an impact in large and small companies, including leading a SME. I live in French-speaking Switzerland with my wife, two kids and our dog. I love bikes and spending time exploring the Jura Mountains. </p>
					</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 mt-2">The company I would like to acquire should be small - roughly around 50 employees with 1-5 Million Euros/Swiss Francs EBITDA and a potential to grow.   </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">My expertise in marketing and sales is a key asset that will help an SME re-calibrate their commercial strategy and realise their full potential. </p>
					<p class="font__size-16 line__height-24 mt-1"> My experience optimizing processes will helping organizations go from good to great and improve what they are already succeeding in.  </p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                        <img src="img/play-sec-alejandro.png" alt="alt" class="image_video">
                        <div class="play_button left_btn center_btn play_btn_white position-absolute">
                        <a class="d-flex align-items-center fancybox" href="https://youtu.be/WEj8RK1o1Ac" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                        </div>
                     </div>
			</div>
			<div class="col-lg-1"></div>
...
<section class="resume_sec searcher_bg">
	<div class="pt-150 pb-100">
		<div class="row no-gutters">
			...
			<div class="col-lg-8">
				<img src="img/background-alejandro.png" class="resume_img">
			</div>
		</div>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">Alejandro Salcedo</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:alejandro.salcedo@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">alejandro.salcedo@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/alejandrosalcedo-/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
