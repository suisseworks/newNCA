				...
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							...
							<a href="http://novastone-ca.com/marcin-chrusciel-pl.php" class="bg-transparent mt-110 ml-10 font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">Polski</a>
						</div>
					</div>	
					...
					<div class="detail_searcher mt-2">
						...
						<p class="font__size-18 line__height-24"><b style="font-weight: bold;">My name is Marcin Chruściel and I live in Poland. For over 17 years I’ve been gaining experience in managing technology companies at various evolution stages.  </b> </p>
						<p class="font__size-18 line__height-24"><br>After obtaining my MBA from Oxford Brooks University, I took on the role of Managing Director at a Polish branch of an engineering company and for the next couple of years I participated in its growth both organically and via M&As. I am currently establishing a search fund within NCA to acquire and develop an SME and increase value for its stakeholders: founders, investors, employees and customers.
					</p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:marcin.chrusciel@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-50 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Ideation</li>
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Futuristic </li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Learner</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Input  </li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">I look to identify, acquire, and grow a well-established engineering company based in Poland (or, opportunistically, in neighboring Eastern European countries).  
 </p>
					<p class="font__size-16 line__height-24 mt-2">I will primarily focus on the Industrial Automation and Robotics industries, and secondarily on the IT Services and Software sectors. I am passionate about the long-term approach to business relations, and believe they are a mandatory factor of a successful growth strategy. 
					...
					<p class="font__size-16 line__height-24 font__family-efb">I was engaged with large organizations and with single founder businesses. Working for and with private owners, I learned the specifics regarding their companies and helped adopting them to the changing ownership structure.  </p>
					<p class="font__size-16 line__height-24 mt-1"> I enjoy envisioning what the coming months, years or decades could, should or will be like. I instinctively create detailed and vivid images of what the future promises, and can translate them to specific actions which lead to making them a reality. I am not afraid of being held accountable of my vision, and will always back up my teams. </p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                        ...
                        <a class="d-flex align-items-center fancybox" href="https://youtu.be/TDzpWzITWsc" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                        </div>
                     </div>
			</div>
			<div class="col-lg-1"></div>
			...
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">You must know for which harbor you are headed if you are to catch the right wind to take you there.</h4>
							<h5 class="font__size-23 line__height-35 font__family-open-sans font-weight-bold mt-3 text-uppercase">Seneca the Younger  </h5>
