				...
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							...
							<a href="http://novastone-ca.com/searcher-george-es.php" class="bg-transparent mt-110 ml-10 font_family-arial language_btn btn btn-prime btn-sm border-radius-25 font__weight-bold shadow-none header_btn" data-brk-library="component__button">Spanish</a>
						</div>
					</div>	
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-50 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						...
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Resilience</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Results Achiever</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Humility</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb"> I am looking for a Spanish company providing B2B services, with yearly revenues of €10-50m. The ideal company would have a long-established track record and a solid reputation, a stable customer base and a strong, consolidated team. </p>
					<p class="font__size-16 line__height-24 mt-2">I am particularly interested in companies related to logistics and adjacent services. </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">In most of my professional life, I have been transforming companies to achieve their best potential. I will apply this experience to the business I will acquire, defining an ambitious aspiration, mapping out a detailed plan to reach it, and enabling the organization to execute with discipline.  </p>
					<p class="font__size-16 line__height-24 mt-1">This begins with the team, which I will strive to strengthen and consolidate. Additionally, I will inject my experience in digitalizing and internationalizing the company.    </p>    
			</div>
		</div>
	</div>
	</div>
