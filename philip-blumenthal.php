				    ...
				    <div class="detail_searcher sbs_deatail mt-5 position-relative">
						<div class="member_content py-4">
                        	<div>
								...
								<p style="margin-top: 8px;  "> <a href="https://www.linkedin.com/in/pmblumenthal/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5  mr-2"><i style="font-size: 20px;" class="fab fa-linkedin-in"></i></a>
								
						    </div>	
	                    </div>
	                    <h2 class="font__halvetica-bold text-uppercase font__size-133 line__height-160 position-relative"><span class="heading_bg">Philip</span> <br> <sapn class="heading_bg_2">Blumenthal</sapn></h2>
				    </div>	
				</div>    
			</div>
			<div class="col-lg-8">
				<div class="searcher_image position-relative">
					<img class="w-100" src="img/Philip.png">
				</div>	
			</div>	
		</div>
	...
	<div class="outer_container container-outer-1600 pb-lg-200 pb-50">
				...
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/philip-logistics.png">
					...
					<div class="col-lg-5 pl-lg-20">
						<div class="image_text_div py-lg-0 py-4 h-100 font__halvetica-bold">
							<p class="font-weight-bold font__size-16">
							  Philip Blumenthal has over two decades of experience in the logistics industry, delivering value and enhancing operational efficiency. Most recently, he played a key role in building ECU’s transformation, generating an incremental three digit million Enterprise Value within three years. His strategic insights and leadership extended to the CEO office of the world's third-largest Logistics provider DB Schenker. Demonstrating financial acumen, he restructured and led their $140 million freight profit and loss (P&L) unit, steering it towards 20% yoy growth. Furthermore, he played a key role in implementing DB Schenker's new ERP system for over 6,000 employees, streamlining processes and enhancing productivity. 
							</p>
							<p class="mt-30 font__size-16 font__halvetica-regular">
							  Operationally Philip scaled a local manufacturing company from a 30-person team to a thriving enterprise with over 250 employees within 9 months. His innovative contributions include building the Freightos Marketplace, now public as NASDAQ:CRGO, and establishing the leading Ocean Price Index (FBX). Philip’s blend of strategic vision, operational expertise, and technological acumen in the Logistics industry makes him a valuable asset to any investor in the freight industry seeking growth and beneficial returns under the brand “Doctor Freight”.
							</p>
						</div>	
					</div>
					<div class="col-lg-2">
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/air-logistics.png">
							<div class="transform_div position-absolute">
					...
					<div class="col-lg-5 pl-lg-20">
						<div class="image_text_div py-lg-0 py-4 h-100 font__halvetica-bold">
							<p class="font-weight-bold font__size-16">
							  We are like to acquire a US-based asset-light Freight Forwarder with 50-200 employees.
							</p>
							<p class="mt-30 font__size-16 font__halvetica-regular">
                              The successful Air/ Ocean provider with over $2mm EBITDA is sold due to successions challenges of the owner. Optimally the revenue growth stems from either a vertical or tradelane focus.
							</p>
						</div>	
					</div>
					<div class="col-lg-2">
			...
			<div class="div_section mt-75">	
				<div class="row">
					<div class="col-lg-5 pr-lg-20">
						<div class="image_content_div position-relative">
							<img class="w-100" src="img/shipment-processing.png">
							<div class="transform_div position-absolute">
					...
					<div class="col-lg-5 pl-lg-20">
						<div class="image_text_div py-lg-0 py-4 h-100 font__halvetica-bold">
							<p class="font-weight-bold font__size-16">
							 To achieve greater efficiency in shipment processing and make the most of digital resources, it's vital to deploy shelf-ready tools for online tracking, quoting, booking, and payment. By doing so, we will enhance visibility and streamline processes, saving valuable time and effort. Additionally by utilizing shelf-ready bots and Robotic Process Automation (RPA) technologies, we will achieve bottom line savings.
							</p>
							<p class="mt-30 font__size-16 font__halvetica-regular">
							 To boost top-line earnings, investing in marketing and additional sales resources we will communicate our benefits to customers more effectively increasing market share and share of wallet. To improve productivity, automation is key, and standardizing processes can help eliminate unnecessary paperwork and reporting. Finally, to maximize your returns, invest in vertical-focused sales and marketing, and you could see a 3-5x return on the gross profit.
							</p>
						</div>	
					</div>
					<div class="col-lg-2">
				...
				<div class="video_text about_contact_info pl-45 pr-30 pb-30 w-100 d-flex h-100 align-items-center">
					<div>
						...
						<h2 class="font__size-37 line__height-47 font__halvetica-bold text-uppercase w-100 mb-3 mt__12">
                          Let’s<br> get <br> ship <BR> done<br><br>							 
						</h2>
			...
			<div class="col-lg-8 pl-lg-20">
				<div class="video_div d-flex h-100 pt-lg-0 pt-50">
					<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
	                    <img src="img/philip-thumbnail.png" alt="alt" class="image_video object-fit_cover w-100 h-100">
	                    <div class="sbs_btn play_button left_btn center_btn play_btn_white position-absolute">
		                    <a class="d-flex align-items-center fancybox" href="https://youtu.be/F8CFjCy8p2U?si=U4GpbG1T4G5JCzkO" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-18 font__family-open-sans">PLAY</span></a>
	                    </div>
	                </div>
				</div>	
			</div>	
		...
		<div class="row pt-50 pb-130">
			<div class="col-lg-4 pr-lg-20">
				<div class="learn_more_btns sbs_download_btn resume_btn pt-30 pb-30 pl-70 pr-70 d-flex justify-content-center">
					<a download href="docs/" type="button" class="pb-1 btn text-primary font-weight-bold text-left font__family-open-sans text-uppercase font__size-45 line__height-60 p-0 m-0">DOWNLOAD<br> RESUME
				...
				<div class="info_text sabastien_col mt-lg-0 mt-50 p-xs-0 pl-50 pr-50 pt-100 pb-100">
                    ...
                    <ul class="pl-0 mt-30">
                    	<li class="w-100 mb-30">
                    		<a class="font__halvetica-bold pr-50 text-white font__size-38" href="mailTo:philip.blumenthal@novastone-ca.com">philip.blumenthal@novastone-ca.com</a>
                    	</li>
                    </ul>
				</div>	
			</div>	
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-27 font__family-avenir text-capitalize line__height-70 text-white">Philip Blumenthal</h1>
				...
				<div class="col-12 col-lg-5 text-lg-right">
					<div class="searcher_mail d-flex align-items-center justify-content-end mt-3 pt-1">
						<a href="mailTo:philip.blumenthal@novastone-ca.com" class="font__size-17 text-brand-primary font__halvetica-bold font-weight-bold underline mr-3"><span>philip.blumenthal@novastone-ca.com</span></a>
						<a href="https://www.linkedin.com/in/pmblumenthal/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
