	...
	<div class="row no-gutters">
		<div class="col-lg-6">
			<div class="searcher_jan_img">
				<img src="img/philip-blumenthal.png">
			</div>
		</div>
				...
				<div class="searcher_content pt-100 ml-4">
					...
					<div class="align-self-lg-stretch">
						<div class="brk-header__item h-100 d-flex align-items-center">
							<a href="https://www.linkedin.com/in/pmblumenthal/" target="_blank" class="social_icon searcher_linkdin mt-100 d-inline-flex align-items-center ml-2 justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					...
					<div class="detail_searcher mt-2">
						<h2 class="font__family-efb text-uppercase line__height-90">Philip <br> Blumenthal</h2>
						<h4 class="font__size-38 mt-4">NCA Entrepreneur</h4>
						<div class="yaers_div d-flex align-items-center font__family-open-sans my-4">
							<span class="font-weight-bold font__size-22">2024</span><i class="fa fa-arrow-right mx-1 px-1 text-brand-primary font__size-18"></i><span class="font-weight-bold font__size-22">2025</span>
						</div>
						<p class="font__size-18 line__height-24"> 
                          Growing up in Columbus, Ohio is where his entrepreneurial spirit was fostered. Founding his first company at the age of 17. As a former Olympic level athlete turned highly analytical executive with 20+ years of progressive leadership experience. He is an ethical leader with success developing and implementing operational solutions and strategic growth initiatives improving revenue growth, profitability, market penetration, and organizational sustainability. As a strategic thinker and decision maker, he possesses an innate ability to translate creative and innovative vision to formulate an operational plan to execute and achieve goals. He also thrives as an adaptable and collaborative communicator building relationships within all levels of the organization providing coaching and leadership in culturally diverse, fast-paced environments.
						  </p>
					</div>
					<div class="contact_me_btn bg-primary pl-50 py-4 mt-5">
						<a href="mailto:philip.blumenthal@novastone-ca.com" type="button" class="btn text-white font__family-efb">Contact<span class="ml-3"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="31" viewBox="0 0 30 31">
								  <defs>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-4">
				<div class="key_skill position-relative pl-90 pr-50 pb-80 pt-50 ml-40">
					...
					<ul class="ml-5 pl-4">
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Leadership & Team Building</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Infrastructure Development</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Strategic Partnerships</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>System & Process Improvement</li>
						<li class="font__size-20 text-light d-flex align-items-center mb-4"><i class="fa fa-check font__size-16 text-dark bg-light rounded mr-3"></i>Financial Controls & Compliance</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-6 pl-0">
				<div class="my_search_content bg-white pl-80 pr-80 pt-60 pb-60 position-relative">
					...
					<p class="font__size-16 line__height-24 font__family-efb">  
                      ...
                      My passion is helping others live an optimal life. Aa such my intention is to acquire a business in the health technology space.
					<p class="font__size-16 line__height-24 mt-2"> Focusing in on headquarters on the coasts of North America, with ability to expand nationally.  </p>
					...
					<p class="font__size-16 line__height-24 font__family-efb">My background is non-traditional and diverse in nature. Which allows me to provide unique perspectives, while instituting solid growth and operational success strategies. </p>
					<p class="font__size-16 line__height-24 mt-1">Drawing on 20 years of experience supporting company launches, capital raise, growth strategies and acquisition preparation. Believing success is total team effort and taking on a steward leadership approach.</p>    
			</div>
		</div>
	</div>
	</div>
		...
		<div class="row no-gutters">
			...
			<div class="col-lg-10">
				<div class="image_caption_vidio" data-brk-library="component__image_caption_css">
                        <img src="img/philip-thumbnail.png" alt="alt" class="image_video">
                        <div class="play_button left_btn center_btn play_btn_white position-absolute">
                        <a class="d-flex align-items-center fancybox" href="https://youtu.be/F8CFjCy8p2U?si=OCmJ6Az7oWyOPbX3" data-brk-library="fancybox"><i class="fas fa-play font__size-50"></i><span class="ml-2 font__size-20">PLAY</span></a>
                        </div>
                     </div>
			</div>
			<div class="col-lg-1"></div>
...
<section class="resume_sec searcher_bg">
	<div class="pt-150 pb-100">
		<div class="row no-gutters">
			...
			<div class="col-lg-8">
				<img src="img/background-stewart.png" class="resume_img">
			</div>
		</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-4">
				<div class="about_contact_info pl-100 bg-white pr-100 pt-60 pb-80">
					...
					<a class="font__size-25 font__family-open-sans font-weight-bold" href="mailTo:philip.blumenthal@novastone-ca.com">philip.blumenthal@novastone-ca.com</a>
				</div>
				</div>
			</div>
			<div class="col-lg-2"></div>
			  <div class="col-lg-6">
				<div class="pouse_sec d-flex pt-60">
					...
					<div class="headline">
							<h4 class="mb-3 underline font__size-32 line__height-48 font__family-efm wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">The greatness of a man is not in how much wealth he acquires, but in his integrity and his ability to affect those around him positively.</h4>
							<h5 class="font__size-23 line__height-35 font__family-open-sans font-weight-bold mt-3 text-uppercase">Bob Marley</h5>
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="searcher_about_us">
						<div class="jan_title d-flex align-items-baseline">
							<h1 class="font__size-30 font__family-efb line__height-70 text-white">Philip Blumenthal</h1>
				...
				<div class="col-12 col-lg-5 text-right">
					<div class="searcher_mail mt-3 pt-1">
						<a href="mailTo:philip.blumenthal@novastone-ca.com" class="font__size-17 text-brand-primary font__family-open-sans font-weight-bold mr-2">philip.blumenthal@novastone-ca.com</a>
						<a href="https://www.linkedin.com/in/pmblumenthal/" target="_blank" class="social_icon d-inline-flex align-items-center justify-content-center border-radius-5 p-1 font__family-avenir"><i class="fab fa-linkedin-in font__size-18"></i></a>
					</div>
				</div>
			</div>
